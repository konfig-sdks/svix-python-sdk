...
from svix_python_sdk.model.message_attempt_out import MessageAttemptOut as MessageAttemptOutSchema
...
from svix_python_sdk.type.message_attempt_out import MessageAttemptOut

from ...api_client import Dictionary
from svix_python_sdk.pydantic.message_attempt_out import MessageAttemptOut as MessageAttemptOutPydantic
...
SchemaFor200ResponseBodyApplicationJson = MessageAttemptOutSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: MessageAttemptOut
...
class BaseApi(api_client.Api):
    ...
    def _get_by_destination_mapped_args(
        self,
        app_id: str,
        msg_id: str,
        attempt_id: str,
    ...
    async def _aget_by_destination_oapg(
        self,
...
class GetByDestinationRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_by_destination(
        self,
        app_id: str,
        msg_id: str,
        attempt_id: str,
        **kwargs,
        ...
        args = self._get_by_destination_mapped_args(
            app_id=app_id,
            msg_id=msg_id,
            attempt_id=attempt_id,
        )
        return await self._aget_by_destination_oapg(
    ...
    def get_by_destination(
        ...
        return self._get_by_destination_oapg(
            path_params=args.path,
        )

class GetByDestination(BaseApi):
    ...
    async def aget_by_destination(
        ...
        validate: bool = False,
        **kwargs,
    ) -> MessageAttemptOutPydantic:
        raw_response = await self.raw.aget_by_destination(
            app_id=app_id,
            msg_id=msg_id,
            attempt_id=attempt_id,
            **kwargs,
        ...
        if validate:
            return MessageAttemptOutPydantic(**raw_response.body)
        return api_client.construct_model_instance(MessageAttemptOutPydantic, raw_response.body)
    ...
    def get_by_destination(
        ...
        raw_response = self.raw.get_by_destination(
            app_id=app_id,
            msg_id=msg_id,
            attempt_id=attempt_id,
        )
