...
class BaseApi(api_client.Api):
    ...
    def _get_by_attempt_mapped_args(
        self,
        app_id: str,
        msg_id: str,
        attempt_id: str,
    ...
    async def _aget_by_attempt_oapg(
        self,
...
class GetByAttemptRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_by_attempt(
        self,
        app_id: str,
        msg_id: str,
        attempt_id: str,
        **kwargs,
        ...
        args = self._get_by_attempt_mapped_args(
            app_id=app_id,
            msg_id=msg_id,
            attempt_id=attempt_id,
        )
        return await self._aget_by_attempt_oapg(
    ...
    def get_by_attempt(
        ...
        return self._get_by_attempt_oapg(
            path_params=args.path,
        )

class GetByAttempt(BaseApi):
    ...
    async def aget_by_attempt(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_by_attempt(
            app_id=app_id,
            msg_id=msg_id,
            attempt_id=attempt_id,
            **kwargs,
    ...
    def get_by_attempt(
        ...
        raw_response = self.raw.get_by_attempt(
            app_id=app_id,
            msg_id=msg_id,
            attempt_id=attempt_id,
        )
