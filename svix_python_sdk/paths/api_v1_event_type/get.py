...
from svix_python_sdk.model.list_response_event_type_out import ListResponseEventTypeOut as ListResponseEventTypeOutSchema

from svix_python_sdk.type.http_error_out import HttpErrorOut
from svix_python_sdk.type.list_response_event_type_out import ListResponseEventTypeOut
...
from svix_python_sdk.pydantic.list_response_event_type_out import ListResponseEventTypeOut as ListResponseEventTypeOutPydantic
...
SchemaFor200ResponseBodyApplicationJson = ListResponseEventTypeOutSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ListResponseEventTypeOut
...
class GetList(BaseApi):
    ...
    async def aget_list(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ListResponseEventTypeOutPydantic:
        ...
        if validate:
            return ListResponseEventTypeOutPydantic(**raw_response.body)
        return api_client.construct_model_instance(ListResponseEventTypeOutPydantic, raw_response.body)
