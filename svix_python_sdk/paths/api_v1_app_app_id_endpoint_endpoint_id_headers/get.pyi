...
from svix_python_sdk.model.endpoint_headers_out import EndpointHeadersOut as EndpointHeadersOutSchema

from svix_python_sdk.type.http_error_out import HttpErrorOut
from svix_python_sdk.type.endpoint_headers_out import EndpointHeadersOut
...
from svix_python_sdk.pydantic.endpoint_headers_out import EndpointHeadersOut as EndpointHeadersOutPydantic
...
SchemaFor200ResponseBodyApplicationJson = EndpointHeadersOutSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: EndpointHeadersOut
...
class GetHeadersRaw(BaseApi):
    ...
    async def aget_headers(
        ...
        **kwargs,
        ...
        args = self._get_headers_mapped_args(
            app_id=app_id,
            endpoint_id=endpoint_id,
        )
        return await self._aget_headers_oapg(
    ...
    def get_headers(
        ...
        return self._get_headers_oapg(
            path_params=args.path,
        )

class GetHeaders(BaseApi):
    ...
    async def aget_headers(
        ...
        validate: bool = False,
        **kwargs,
    ) -> EndpointHeadersOutPydantic:
        raw_response = await self.raw.aget_headers(
            app_id=app_id,
            endpoint_id=endpoint_id,
            **kwargs,
        )
        if validate:
            return EndpointHeadersOutPydantic(**raw_response.body)
        return api_client.construct_model_instance(EndpointHeadersOutPydantic, raw_response.body)
    ...
    def get_headers(
        ...
        raw_response = self.raw.get_headers(
            app_id=app_id,
            endpoint_id=endpoint_id,
        )
        if validate:
