...
class BaseApi(api_client.Api):
    ...
    def _update_headers_mapped_args(
        self,
    ...
    async def _aupdate_headers_oapg(
        self,
...
class UpdateHeadersRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aupdate_headers(
        self,
        headers: EndpointHeadersInHeaders,
        app_id: str,
        endpoint_id: str,
        **kwargs,
        ...
        args = self._update_headers_mapped_args(
            headers=headers,
            app_id=app_id,
            endpoint_id=endpoint_id,
        )
        return await self._aupdate_headers_oapg(
            body=args.body,
    ...
    def update_headers(
        ...
        return self._update_headers_oapg(
            body=args.body,
            path_params=args.path,
        )

class UpdateHeaders(BaseApi):
    ...
    async def aupdate_headers(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aupdate_headers(
            headers=headers,
            app_id=app_id,
            endpoint_id=endpoint_id,
            **kwargs,
    ...
    def update_headers(
        ...
        raw_response = self.raw.update_headers(
            headers=headers,
            app_id=app_id,
            endpoint_id=endpoint_id,
        )
