...
class BaseApi(api_client.Api):
    ...
    def _expire_all_tokens_mapped_args(
        self,
        app_id: str,
    ...
    async def _aexpire_all_tokens_oapg(
        self,
...
class ExpireAllTokensRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aexpire_all_tokens(
        self,
        app_id: str,
        expiry: typing.Optional[typing.Optional[int]] = None,
        idempotency_key: typing.Optional[str] = None,
        **kwargs,
        ...
        args = self._expire_all_tokens_mapped_args(
            app_id=app_id,
            expiry=expiry,
            idempotency_key=idempotency_key,
        )
        return await self._aexpire_all_tokens_oapg(
            body=args.body,
    ...
    def expire_all_tokens(
        ...
        return self._expire_all_tokens_oapg(
            body=args.body,
            header_params=args.header,
            path_params=args.path,
        )

class ExpireAllTokens(BaseApi):
    ...
    async def aexpire_all_tokens(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aexpire_all_tokens(
            app_id=app_id,
            expiry=expiry,
            idempotency_key=idempotency_key,
            **kwargs,
    ...
    def expire_all_tokens(
        ...
        raw_response = self.raw.expire_all_tokens(
            app_id=app_id,
            expiry=expiry,
            idempotency_key=idempotency_key,
        )
