...
class BaseApi(api_client.Api):
    ...
    def _resend_webhook_mapped_args(
        self,
        app_id: str,
        msg_id: str,
        endpoint_id: str,
    ...
    async def _aresend_webhook_oapg(
        self,
...
class ResendWebhookRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aresend_webhook(
        self,
        app_id: str,
        msg_id: str,
        endpoint_id: str,
        ...
        **kwargs,
        ...
        args = self._resend_webhook_mapped_args(
            app_id=app_id,
            msg_id=msg_id,
            endpoint_id=endpoint_id,
            idempotency_key=idempotency_key,
        )
        return await self._aresend_webhook_oapg(
    ...
    def resend_webhook(
        ...
        return self._resend_webhook_oapg(
            header_params=args.header,
            path_params=args.path,
        )

class ResendWebhook(BaseApi):
    ...
    async def aresend_webhook(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aresend_webhook(
            app_id=app_id,
            msg_id=msg_id,
            endpoint_id=endpoint_id,
            idempotency_key=idempotency_key,
    ...
    def resend_webhook(
        ...
        raw_response = self.raw.resend_webhook(
            app_id=app_id,
            msg_id=msg_id,
            endpoint_id=endpoint_id,
            idempotency_key=idempotency_key,
