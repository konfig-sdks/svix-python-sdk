...
from svix_python_sdk.model.endpoint_transformation_out import EndpointTransformationOut as EndpointTransformationOutSchema
...
from svix_python_sdk.type.endpoint_transformation_out import EndpointTransformationOut

from ...api_client import Dictionary
from svix_python_sdk.pydantic.endpoint_transformation_out import EndpointTransformationOut as EndpointTransformationOutPydantic
...
SchemaFor200ResponseBodyApplicationJson = EndpointTransformationOutSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: EndpointTransformationOut
...
class BaseApi(api_client.Api):
    ...
    def _get_transformation_code_mapped_args(
        self,
        app_id: str,
        endpoint_id: str,
    ...
    async def _aget_transformation_code_oapg(
        self,
    ...
    def _get_transformation_code_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class GetTransformationCodeRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_transformation_code(
        self,
        app_id: str,
        endpoint_id: str,
        **kwargs,
        ...
        args = self._get_transformation_code_mapped_args(
            app_id=app_id,
            endpoint_id=endpoint_id,
        )
        return await self._aget_transformation_code_oapg(
    ...
    def get_transformation_code(
        ...
        return self._get_transformation_code_oapg(
            path_params=args.path,
        )

class GetTransformationCode(BaseApi):
    ...
    async def aget_transformation_code(
        ...
        validate: bool = False,
        **kwargs,
    ) -> EndpointTransformationOutPydantic:
        raw_response = await self.raw.aget_transformation_code(
            app_id=app_id,
            endpoint_id=endpoint_id,
            **kwargs,
        )
        if validate:
            return EndpointTransformationOutPydantic(**raw_response.body)
        return api_client.construct_model_instance(EndpointTransformationOutPydantic, raw_response.body)
    ...
    def get_transformation_code(
        ...
        raw_response = self.raw.get_transformation_code(
            app_id=app_id,
            endpoint_id=endpoint_id,
        )
        if validate:
