...
from svix_python_sdk.model.endpoint_secret_rotate_in import EndpointSecretRotateIn as EndpointSecretRotateInSchema
...
from svix_python_sdk.type.endpoint_secret_rotate_in import EndpointSecretRotateIn

from ...api_client import Dictionary
from svix_python_sdk.pydantic.http_error_out import HttpErrorOut as HttpErrorOutPydantic
from svix_python_sdk.pydantic.endpoint_secret_rotate_in import EndpointSecretRotateIn as EndpointSecretRotateInPydantic
...
# body param
SchemaForRequestBodyApplicationJson = EndpointSecretRotateInSchema
...
class BaseApi(api_client.Api):
    ...
    def _rotate_secret_mapped_args(
        self,
        app_id: str,
        endpoint_id: str,
        key: typing.Optional[typing.Optional[str]] = None,
    ...
    async def _arotate_secret_oapg(
        self,
...
class RotateSecretRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def arotate_secret(
        self,
        app_id: str,
        endpoint_id: str,
        key: typing.Optional[typing.Optional[str]] = None,
        ...
        **kwargs,
        ...
        args = self._rotate_secret_mapped_args(
            app_id=app_id,
            endpoint_id=endpoint_id,
            key=key,
            idempotency_key=idempotency_key,
        )
        return await self._arotate_secret_oapg(
            body=args.body,
    ...
    def rotate_secret(
        ...
        return self._rotate_secret_oapg(
            body=args.body,
            header_params=args.header,
            path_params=args.path,
        )

class RotateSecret(BaseApi):
    ...
    async def arotate_secret(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.arotate_secret(
            app_id=app_id,
            endpoint_id=endpoint_id,
            key=key,
            idempotency_key=idempotency_key,
    ...
    def rotate_secret(
        ...
        raw_response = self.raw.rotate_secret(
            app_id=app_id,
            endpoint_id=endpoint_id,
            key=key,
            idempotency_key=idempotency_key,
