...
from svix_python_sdk.model.integration_in import IntegrationIn as IntegrationInSchema
...
from svix_python_sdk.type.integration_in import IntegrationIn
...
from svix_python_sdk.pydantic.integration_in import IntegrationIn as IntegrationInPydantic
...
# body param
SchemaForRequestBodyApplicationJson = IntegrationInSchema
...
SchemaFor201ResponseBodyApplicationJson = IntegrationOutSchema
...
class BaseApi(api_client.Api):
    ...
    def _create_new_integration_mapped_args(
        self,
        name: str,
        app_id: str,
    ...
    async def _acreate_new_integration_oapg(
        self,
    ...
    def _create_new_integration_oapg(
        self,
        body: typing.Any = None,
            header_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
...
class CreateNewIntegrationRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def acreate_new_integration(
        self,
        name: str,
        app_id: str,
        idempotency_key: typing.Optional[str] = None,
        **kwargs,
        ...
        args = self._create_new_integration_mapped_args(
            name=name,
            app_id=app_id,
            idempotency_key=idempotency_key,
        )
        return await self._acreate_new_integration_oapg(
            body=args.body,
    ...
    def create_new_integration(
        ...
        return self._create_new_integration_oapg(
            body=args.body,
            header_params=args.header,
            path_params=args.path,
        )

class CreateNewIntegration(BaseApi):
    ...
    async def acreate_new_integration(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.acreate_new_integration(
            name=name,
            app_id=app_id,
            idempotency_key=idempotency_key,
            **kwargs,
    ...
    def create_new_integration(
        ...
        raw_response = self.raw.create_new_integration(
            name=name,
            app_id=app_id,
            idempotency_key=idempotency_key,
        )
