...
from svix_python_sdk.model.app_usage_stats_in_app_ids import AppUsageStatsInAppIds as AppUsageStatsInAppIdsSchema
from svix_python_sdk.model.app_usage_stats_out import AppUsageStatsOut as AppUsageStatsOutSchema
from svix_python_sdk.model.app_usage_stats_in import AppUsageStatsIn as AppUsageStatsInSchema

from svix_python_sdk.type.app_usage_stats_out import AppUsageStatsOut
from svix_python_sdk.type.http_error_out import HttpErrorOut
from svix_python_sdk.type.app_usage_stats_in_app_ids import AppUsageStatsInAppIds
from svix_python_sdk.type.http_validation_error import HTTPValidationError
from svix_python_sdk.type.app_usage_stats_in import AppUsageStatsIn

from ...api_client import Dictionary
from svix_python_sdk.pydantic.app_usage_stats_in import AppUsageStatsIn as AppUsageStatsInPydantic
from svix_python_sdk.pydantic.app_usage_stats_out import AppUsageStatsOut as AppUsageStatsOutPydantic
from svix_python_sdk.pydantic.http_error_out import HttpErrorOut as HttpErrorOutPydantic
from svix_python_sdk.pydantic.app_usage_stats_in_app_ids import AppUsageStatsInAppIds as AppUsageStatsInAppIdsPydantic
...
# body param
SchemaForRequestBodyApplicationJson = AppUsageStatsInSchema


request_body_app_usage_stats_in = api_client.RequestBody(
    content={
...
SchemaFor202ResponseBodyApplicationJson = AppUsageStatsOutSchema


@dataclass
class ApiResponseFor202(api_client.ApiResponse):
    body: AppUsageStatsOut
...
class BaseApi(api_client.Api):
    ...
    def _calculate_message_destinations_for_apps_mapped_args(
        self,
        since: datetime,
        until: datetime,
        app_ids: typing.Optional[AppUsageStatsInAppIds] = None,
    ...
    async def _acalculate_message_destinations_for_apps_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/api/v1/stats/usage/app',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        serialized_data = request_body_app_usage_stats_in.serialize(body, content_type)
    ...
    def _calculate_message_destinations_for_apps_oapg(
        self,
        body: typing.Any = None,
            header_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class CalculateMessageDestinationsForAppsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def acalculate_message_destinations_for_apps(
        self,
        since: datetime,
        until: datetime,
        app_ids: typing.Optional[AppUsageStatsInAppIds] = None,
        ...
        **kwargs,
        ...
        args = self._calculate_message_destinations_for_apps_mapped_args(
            since=since,
            until=until,
            app_ids=app_ids,
            idempotency_key=idempotency_key,
        )
        return await self._acalculate_message_destinations_for_apps_oapg(
            body=args.body,
            header_params=args.header,
            **kwargs,
        )
    
    def calculate_message_destinations_for_apps(
        self,
        since: datetime,
        until: datetime,
        app_ids: typing.Optional[AppUsageStatsInAppIds] = None,
        ...
        return self._calculate_message_destinations_for_apps_oapg(
            body=args.body,
            header_params=args.header,
        )

class CalculateMessageDestinationsForApps(BaseApi):
    ...
    async def acalculate_message_destinations_for_apps(
        ...
        validate: bool = False,
        **kwargs,
    ) -> AppUsageStatsOutPydantic:
        raw_response = await self.raw.acalculate_message_destinations_for_apps(
            since=since,
            until=until,
            app_ids=app_ids,
            idempotency_key=idempotency_key,
        ...
        if validate:
            return AppUsageStatsOutPydantic(**raw_response.body)
        return api_client.construct_model_instance(AppUsageStatsOutPydantic, raw_response.body)
    ...
    def calculate_message_destinations_for_apps(
        ...
        raw_response = self.raw.calculate_message_destinations_for_apps(
            since=since,
            until=until,
            app_ids=app_ids,
            idempotency_key=idempotency_key,
