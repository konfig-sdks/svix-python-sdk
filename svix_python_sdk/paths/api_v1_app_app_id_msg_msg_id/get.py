...
SchemaFor200ResponseBodyApplicationJson = MessageOutSchema
...
class BaseApi(api_client.Api):
    ...
    def _get_by_id_or_event_id_mapped_args(
        self,
        app_id: str,
        msg_id: str,
    ...
    async def _aget_by_id_or_event_id_oapg(
        self,
    ...
    def _get_by_id_or_event_id_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class GetByIdOrEventIdRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_by_id_or_event_id(
        self,
        app_id: str,
        msg_id: str,
        with_content: typing.Optional[bool] = None,
        **kwargs,
        ...
        args = self._get_by_id_or_event_id_mapped_args(
            app_id=app_id,
            msg_id=msg_id,
            with_content=with_content,
        )
        return await self._aget_by_id_or_event_id_oapg(
            query_params=args.query,
            path_params=args.path,
            **kwargs,
        )
    
    def get_by_id_or_event_id(
        self,
        app_id: str,
        msg_id: str,
        with_content: typing.Optional[bool] = None,
        ...
        return self._get_by_id_or_event_id_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetByIdOrEventId(BaseApi):
    ...
    async def aget_by_id_or_event_id(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_by_id_or_event_id(
            app_id=app_id,
            msg_id=msg_id,
            with_content=with_content,
            **kwargs,
    ...
    def get_by_id_or_event_id(
        ...
        raw_response = self.raw.get_by_id_or_event_id(
            app_id=app_id,
            msg_id=msg_id,
            with_content=with_content,
        )
