...
from svix_python_sdk.model.integration_out import IntegrationOut as IntegrationOutSchema
from svix_python_sdk.model.integration_update import IntegrationUpdate as IntegrationUpdateSchema

from svix_python_sdk.type.http_error_out import HttpErrorOut
from svix_python_sdk.type.integration_update import IntegrationUpdate
from svix_python_sdk.type.http_validation_error import HTTPValidationError
from svix_python_sdk.type.integration_out import IntegrationOut

from ...api_client import Dictionary
from svix_python_sdk.pydantic.integration_out import IntegrationOut as IntegrationOutPydantic
from svix_python_sdk.pydantic.http_error_out import HttpErrorOut as HttpErrorOutPydantic
from svix_python_sdk.pydantic.integration_update import IntegrationUpdate as IntegrationUpdatePydantic
...
# body param
SchemaForRequestBodyApplicationJson = IntegrationUpdateSchema
...
SchemaFor200ResponseBodyApplicationJson = IntegrationOutSchema
...
class BaseApi(api_client.Api):
    ...
    def _update_integration_by_id_mapped_args(
        self,
        name: str,
        app_id: str,
        integ_id: str,
    ...
    async def _aupdate_integration_by_id_oapg(
        self,
    ...
    def _update_integration_by_id_oapg(
        self,
        body: typing.Any = None,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class UpdateIntegrationByIdRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aupdate_integration_by_id(
        self,
        name: str,
        app_id: str,
        integ_id: str,
        **kwargs,
        ...
        args = self._update_integration_by_id_mapped_args(
            name=name,
            app_id=app_id,
            integ_id=integ_id,
        )
        return await self._aupdate_integration_by_id_oapg(
            body=args.body,
            path_params=args.path,
            **kwargs,
        )
    
    def update_integration_by_id(
        self,
        name: str,
        app_id: str,
        integ_id: str,
        ...
        return self._update_integration_by_id_oapg(
            body=args.body,
            path_params=args.path,
        )

class UpdateIntegrationById(BaseApi):
    ...
    async def aupdate_integration_by_id(
        ...
        validate: bool = False,
        **kwargs,
    ) -> IntegrationOutPydantic:
        raw_response = await self.raw.aupdate_integration_by_id(
            name=name,
            app_id=app_id,
            integ_id=integ_id,
            **kwargs,
        ...
        if validate:
            return IntegrationOutPydantic(**raw_response.body)
        return api_client.construct_model_instance(IntegrationOutPydantic, raw_response.body)
    ...
    def update_integration_by_id(
        ...
        raw_response = self.raw.update_integration_by_id(
            name=name,
            app_id=app_id,
            integ_id=integ_id,
        )
