...
from svix_python_sdk.model.ordering import Ordering as OrderingSchema
...
from svix_python_sdk.model.background_task_type import BackgroundTaskType as BackgroundTaskTypeSchema
from svix_python_sdk.model.list_response_background_task_out import ListResponseBackgroundTaskOut as ListResponseBackgroundTaskOutSchema
from svix_python_sdk.model.background_task_status import BackgroundTaskStatus as BackgroundTaskStatusSchema

from svix_python_sdk.type.http_error_out import HttpErrorOut
from svix_python_sdk.type.list_response_background_task_out import ListResponseBackgroundTaskOut
from svix_python_sdk.type.background_task_type import BackgroundTaskType
from svix_python_sdk.type.background_task_status import BackgroundTaskStatus
from svix_python_sdk.type.ordering import Ordering
from svix_python_sdk.type.http_validation_error import HTTPValidationError

from ...api_client import Dictionary
from svix_python_sdk.pydantic.list_response_background_task_out import ListResponseBackgroundTaskOut as ListResponseBackgroundTaskOutPydantic
from svix_python_sdk.pydantic.http_error_out import HttpErrorOut as HttpErrorOutPydantic
from svix_python_sdk.pydantic.ordering import Ordering as OrderingPydantic
from svix_python_sdk.pydantic.background_task_status import BackgroundTaskStatus as BackgroundTaskStatusPydantic
from svix_python_sdk.pydantic.background_task_type import BackgroundTaskType as BackgroundTaskTypePydantic
from svix_python_sdk.pydantic.http_validation_error import HTTPValidationError as HTTPValidationErrorPydantic

from . import path

# Query params
StatusSchema = BackgroundTaskStatusSchema
TaskSchema = BackgroundTaskTypeSchema
...
request_query_status = api_client.QueryParameter(
    ...
    schema=BackgroundTaskStatus,
    explode=True,
)
request_query_task = api_client.QueryParameter(
    name="task",
    style=api_client.ParameterStyle.FORM,
    schema=BackgroundTaskType,
    explode=True,
)
...
SchemaFor200ResponseBodyApplicationJson = ListResponseBackgroundTaskOutSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ListResponseBackgroundTaskOut
...
class BaseApi(api_client.Api):
    ...
    def _list_recent_tasks_mapped_args(
        self,
        status: typing.Optional[BackgroundTaskStatus] = None,
        task: typing.Optional[BackgroundTaskType] = None,
    ...
    async def _alist_recent_tasks_oapg(
        self,
...
class ListRecentTasksRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def alist_recent_tasks(
        self,
        status: typing.Optional[BackgroundTaskStatus] = None,
        task: typing.Optional[BackgroundTaskType] = None,
        limit: typing.Optional[int] = None,
        ...
        **kwargs,
        ...
        args = self._list_recent_tasks_mapped_args(
            status=status,
            task=task,
            limit=limit,
            iterator=iterator,
        ...
        return await self._alist_recent_tasks_oapg(
    ...
    def list_recent_tasks(
        ...
        return self._list_recent_tasks_oapg(
            query_params=args.query,
        )

class ListRecentTasks(BaseApi):
    ...
    async def alist_recent_tasks(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ListResponseBackgroundTaskOutPydantic:
        raw_response = await self.raw.alist_recent_tasks(
            status=status,
            task=task,
            limit=limit,
            iterator=iterator,
        ...
        if validate:
            return ListResponseBackgroundTaskOutPydantic(**raw_response.body)
        return api_client.construct_model_instance(ListResponseBackgroundTaskOutPydantic, raw_response.body)
    ...
    def list_recent_tasks(
        ...
        raw_response = self.raw.list_recent_tasks(
            status=status,
            task=task,
            limit=limit,
            iterator=iterator,
