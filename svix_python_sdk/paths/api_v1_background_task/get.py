...
request_query_status = api_client.QueryParameter(
    ...
    schema=BackgroundTaskStatusSchema,
    explode=True,
)
request_query_task = api_client.QueryParameter(
    name="task",
    style=api_client.ParameterStyle.FORM,
    schema=BackgroundTaskTypeSchema,
    explode=True,
)
...
class BaseApi(api_client.Api):
    ...
    def _get_past_tasks_mapped_args(
        self,
    ...
    async def _aget_past_tasks_oapg(
        self,
...
class GetPastTasksRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_past_tasks(
        self,
        status: typing.Optional[BackgroundTaskStatus] = None,
        task: typing.Optional[BackgroundTaskType] = None,
        limit: typing.Optional[int] = None,
        ...
        **kwargs,
        ...
        args = self._get_past_tasks_mapped_args(
            status=status,
            task=task,
            limit=limit,
            iterator=iterator,
        ...
        return await self._aget_past_tasks_oapg(
    ...
    def get_past_tasks(
        ...
        return self._get_past_tasks_oapg(
            query_params=args.query,
        )

class GetPastTasks(BaseApi):
    ...
    async def aget_past_tasks(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_past_tasks(
            status=status,
            task=task,
            limit=limit,
            iterator=iterator,
    ...
    def get_past_tasks(
        ...
        raw_response = self.raw.get_past_tasks(
            status=status,
            task=task,
            limit=limit,
            iterator=iterator,
