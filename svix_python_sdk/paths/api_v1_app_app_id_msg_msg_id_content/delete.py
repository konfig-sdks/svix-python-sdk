...
class BaseApi(api_client.Api):
    ...
    def _delete_payload_mapped_args(
        self,
        app_id: str,
        msg_id: str,
    ...
    async def _adelete_payload_oapg(
        self,
...
class DeletePayloadRaw(BaseApi):
    ...
    async def adelete_payload(
        ...
        **kwargs,
        ...
        args = self._delete_payload_mapped_args(
            app_id=app_id,
            msg_id=msg_id,
        )
        return await self._adelete_payload_oapg(
    ...
    def delete_payload(
        ...
        return self._delete_payload_oapg(
            path_params=args.path,
        )

class DeletePayload(BaseApi):
    ...
    async def adelete_payload(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.adelete_payload(
            app_id=app_id,
            msg_id=msg_id,
            **kwargs,
        )
    ...
    def delete_payload(
        ...
        raw_response = self.raw.delete_payload(
            app_id=app_id,
            msg_id=msg_id,
        )
