...
from svix_python_sdk.model.list_response_application_out import ListResponseApplicationOut as ListResponseApplicationOutSchema

from svix_python_sdk.type.http_error_out import HttpErrorOut
from svix_python_sdk.type.list_response_application_out import ListResponseApplicationOut
...
from svix_python_sdk.pydantic.list_response_application_out import ListResponseApplicationOut as ListResponseApplicationOutPydantic
...
SchemaFor200ResponseBodyApplicationJson = ListResponseApplicationOutSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ListResponseApplicationOut
...
class ListAll(BaseApi):
    ...
    async def alist_all(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ListResponseApplicationOutPydantic:
        ...
        if validate:
            return ListResponseApplicationOutPydantic(**raw_response.body)
        return api_client.construct_model_instance(ListResponseApplicationOutPydantic, raw_response.body)
