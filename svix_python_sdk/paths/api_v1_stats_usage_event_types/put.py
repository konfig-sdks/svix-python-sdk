...
class BaseApi(api_client.Api):
    ...
    def _calculate_event_types_for_apps_mapped_args(
        self,
    ) -> api_client.MappedArgs:
        args: api_client.MappedArgs = api_client.MappedArgs()
        return args

    async def _acalculate_event_types_for_apps_oapg(
        self,
    ...
    def _calculate_event_types_for_apps_oapg(
        self,
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
...
class CalculateEventTypesForAppsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def acalculate_event_types_for_apps(
        self,
        **kwargs,
    ) -> typing.Union[
        ApiResponseFor202Async,
        ...
        args = self._calculate_event_types_for_apps_mapped_args(
        )
        return await self._acalculate_event_types_for_apps_oapg(
            **kwargs,
        )
    
    def calculate_event_types_for_apps(
        self,
    ) -> typing.Union[
        ApiResponseFor202,
        api_client.ApiResponseWithoutDeserialization,
        ...
        return self._calculate_event_types_for_apps_oapg(
        )

class CalculateEventTypesForApps(BaseApi):
    ...
    async def acalculate_event_types_for_apps(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.acalculate_event_types_for_apps(
            **kwargs,
        )
        if validate:
    ...
    def calculate_event_types_for_apps(
        ...
        raw_response = self.raw.calculate_event_types_for_apps(
        )
        if validate:
            return AggregateEventTypesOutPydantic(**raw_response.body)
        return api_client.construct_model_instance(AggregateEventTypesOutPydantic, raw_response.body)
