...
from svix_python_sdk.model.aggregate_event_types_out import AggregateEventTypesOut as AggregateEventTypesOutSchema

from svix_python_sdk.type.http_error_out import HttpErrorOut
from svix_python_sdk.type.aggregate_event_types_out import AggregateEventTypesOut
from svix_python_sdk.type.http_validation_error import HTTPValidationError

from ...api_client import Dictionary
from svix_python_sdk.pydantic.aggregate_event_types_out import AggregateEventTypesOut as AggregateEventTypesOutPydantic
...
SchemaFor202ResponseBodyApplicationJson = AggregateEventTypesOutSchema


@dataclass
class ApiResponseFor202(api_client.ApiResponse):
    body: AggregateEventTypesOut
...
class BaseApi(api_client.Api):
    ...
    def _calculate_event_types_for_all_apps_mapped_args(
        self,
    ) -> api_client.MappedArgs:
        args: api_client.MappedArgs = api_client.MappedArgs()
        return args

    async def _acalculate_event_types_for_all_apps_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/api/v1/stats/usage/event-types',
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _calculate_event_types_for_all_apps_oapg(
        self,
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
...
class CalculateEventTypesForAllAppsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def acalculate_event_types_for_all_apps(
        self,
        **kwargs,
    ) -> typing.Union[
        ApiResponseFor202Async,
        ...
        args = self._calculate_event_types_for_all_apps_mapped_args(
        )
        return await self._acalculate_event_types_for_all_apps_oapg(
            **kwargs,
        )
    
    def calculate_event_types_for_all_apps(
        self,
    ) -> typing.Union[
        ApiResponseFor202,
        api_client.ApiResponseWithoutDeserialization,
        ...
        return self._calculate_event_types_for_all_apps_oapg(
        )

class CalculateEventTypesForAllApps(BaseApi):

    async def acalculate_event_types_for_all_apps(
        self,
        validate: bool = False,
        **kwargs,
    ) -> AggregateEventTypesOutPydantic:
        raw_response = await self.raw.acalculate_event_types_for_all_apps(
            **kwargs,
        )
        if validate:
            return AggregateEventTypesOutPydantic(**raw_response.body)
        return api_client.construct_model_instance(AggregateEventTypesOutPydantic, raw_response.body)
    ...
    def calculate_event_types_for_all_apps(
        ...
        raw_response = self.raw.calculate_event_types_for_all_apps(
        )
        if validate:
            return AggregateEventTypesOutPydantic(**raw_response.body)
        return api_client.construct_model_instance(AggregateEventTypesOutPydantic, raw_response.body)
