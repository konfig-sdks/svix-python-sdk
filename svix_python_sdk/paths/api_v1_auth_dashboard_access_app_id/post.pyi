...
from svix_python_sdk.model.dashboard_access_out import DashboardAccessOut as DashboardAccessOutSchema

from svix_python_sdk.type.http_error_out import HttpErrorOut
from svix_python_sdk.type.dashboard_access_out import DashboardAccessOut
...
from svix_python_sdk.pydantic.dashboard_access_out import DashboardAccessOut as DashboardAccessOutPydantic
...
SchemaFor200ResponseBodyApplicationJson = DashboardAccessOutSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: DashboardAccessOut
...
class BaseApi(api_client.Api):
    ...
    def _generate_magic_link_mapped_args(
        self,
        app_id: str,
    ...
    async def _agenerate_magic_link_oapg(
        self,
...
class GenerateMagicLinkRaw(BaseApi):
    ...
    async def agenerate_magic_link(
        ...
        **kwargs,
        ...
        args = self._generate_magic_link_mapped_args(
            app_id=app_id,
            idempotency_key=idempotency_key,
        )
        return await self._agenerate_magic_link_oapg(
    ...
    def generate_magic_link(
        ...
        return self._generate_magic_link_oapg(
            header_params=args.header,
            path_params=args.path,
        )

class GenerateMagicLink(BaseApi):
    ...
    async def agenerate_magic_link(
        ...
        validate: bool = False,
        **kwargs,
    ) -> DashboardAccessOutPydantic:
        raw_response = await self.raw.agenerate_magic_link(
            app_id=app_id,
            idempotency_key=idempotency_key,
            **kwargs,
        )
        if validate:
            return DashboardAccessOutPydantic(**raw_response.body)
        return api_client.construct_model_instance(DashboardAccessOutPydantic, raw_response.body)
    ...
    def generate_magic_link(
        ...
        raw_response = self.raw.generate_magic_link(
            app_id=app_id,
            idempotency_key=idempotency_key,
        )
        if validate:
