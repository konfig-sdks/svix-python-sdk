...
class BaseApi(api_client.Api):
    ...
    def _get_magic_links_mapped_args(
        self,
        app_id: str,
    ...
    async def _aget_magic_links_oapg(
        self,
...
class GetMagicLinksRaw(BaseApi):
    ...
    async def aget_magic_links(
        ...
        **kwargs,
        ...
        args = self._get_magic_links_mapped_args(
            app_id=app_id,
            idempotency_key=idempotency_key,
        )
        return await self._aget_magic_links_oapg(
    ...
    def get_magic_links(
        ...
        return self._get_magic_links_oapg(
            header_params=args.header,
            path_params=args.path,
        )

class GetMagicLinks(BaseApi):
    ...
    async def aget_magic_links(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_magic_links(
            app_id=app_id,
            idempotency_key=idempotency_key,
            **kwargs,
        )
    ...
    def get_magic_links(
        ...
        raw_response = self.raw.get_magic_links(
            app_id=app_id,
            idempotency_key=idempotency_key,
        )
        if validate:
