...
from svix_python_sdk.model.endpoint_stats import EndpointStats as EndpointStatsSchema

from svix_python_sdk.type.http_error_out import HttpErrorOut
from svix_python_sdk.type.endpoint_stats import EndpointStats
from svix_python_sdk.type.http_validation_error import HTTPValidationError

from ...api_client import Dictionary
from svix_python_sdk.pydantic.endpoint_stats import EndpointStats as EndpointStatsPydantic
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    ...
    {
        'since': typing.Union[SinceSchema, None, str, datetime, ],
        'until': typing.Union[UntilSchema, None, str, datetime, ],
    },
    total=False
)
...
SchemaFor200ResponseBodyApplicationJson = EndpointStatsSchema
...
class BaseApi(api_client.Api):
    ...
    def _get_stats_mapped_args(
        ...
        app_id: str,
        endpoint_id: str,
        since: typing.Optional[typing.Optional[datetime]] = None,
...
class GetStats(BaseApi):
    ...
    async def aget_stats(
        ...
        **kwargs,
        ...
        if validate:
            return EndpointStatsPydantic(**raw_response.body)
        return api_client.construct_model_instance(EndpointStatsPydantic, raw_response.body)
