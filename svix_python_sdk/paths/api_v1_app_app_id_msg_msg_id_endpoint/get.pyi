...
from svix_python_sdk.model.list_response_message_endpoint_out import ListResponseMessageEndpointOut as ListResponseMessageEndpointOutSchema

from svix_python_sdk.type.http_error_out import HttpErrorOut
from svix_python_sdk.type.list_response_message_endpoint_out import ListResponseMessageEndpointOut
...
from svix_python_sdk.pydantic.list_response_message_endpoint_out import ListResponseMessageEndpointOut as ListResponseMessageEndpointOutPydantic
...
SchemaFor200ResponseBodyApplicationJson = ListResponseMessageEndpointOutSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ListResponseMessageEndpointOut
...
class BaseApi(api_client.Api):
    ...
    def _list_attempted_destinations_mapped_args(
        self,
        app_id: str,
        msg_id: str,
    ...
    async def _alist_attempted_destinations_oapg(
        self,
    ...
    def _list_attempted_destinations_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class ListAttemptedDestinationsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def alist_attempted_destinations(
        self,
        app_id: str,
        msg_id: str,
        limit: typing.Optional[int] = None,
        ...
        **kwargs,
        ...
        args = self._list_attempted_destinations_mapped_args(
            app_id=app_id,
            msg_id=msg_id,
            limit=limit,
            iterator=iterator,
        )
        return await self._alist_attempted_destinations_oapg(
    ...
    def list_attempted_destinations(
        ...
        return self._list_attempted_destinations_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class ListAttemptedDestinations(BaseApi):
    ...
    async def alist_attempted_destinations(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ListResponseMessageEndpointOutPydantic:
        raw_response = await self.raw.alist_attempted_destinations(
            app_id=app_id,
            msg_id=msg_id,
            limit=limit,
            iterator=iterator,
        ...
        if validate:
            return ListResponseMessageEndpointOutPydantic(**raw_response.body)
        return api_client.construct_model_instance(ListResponseMessageEndpointOutPydantic, raw_response.body)
    ...
    def list_attempted_destinations(
        ...
        raw_response = self.raw.list_attempted_destinations(
            app_id=app_id,
            msg_id=msg_id,
            limit=limit,
            iterator=iterator,
