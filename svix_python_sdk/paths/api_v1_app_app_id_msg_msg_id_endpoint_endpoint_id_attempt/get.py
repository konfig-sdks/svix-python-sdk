...
from svix_python_sdk.model.list_response_message_attempt_endpoint_out import ListResponseMessageAttemptEndpointOut as ListResponseMessageAttemptEndpointOutSchema

from svix_python_sdk.type.http_error_out import HttpErrorOut
from svix_python_sdk.type.list_response_message_attempt_endpoint_out import ListResponseMessageAttemptEndpointOut
...
from svix_python_sdk.pydantic.list_response_message_attempt_endpoint_out import ListResponseMessageAttemptEndpointOut as ListResponseMessageAttemptEndpointOutPydantic
...
SchemaFor200ResponseBodyApplicationJson = ListResponseMessageAttemptEndpointOutSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ListResponseMessageAttemptEndpointOut
...
class BaseApi(api_client.Api):
    ...
    def _list_by_endpoint_deprecated_mapped_args(
        self,
        app_id: str,
        msg_id: str,
        endpoint_id: str,
    ...
    async def _alist_by_endpoint_deprecated_oapg(
        self,
    ...
    def _list_by_endpoint_deprecated_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class ListByEndpointDeprecatedRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @api_client.DeprecationWarningOnce(prefix="message_attempt")
    async def alist_by_endpoint_deprecated(
        self,
        app_id: str,
        msg_id: str,
        endpoint_id: str,
        ...
        **kwargs,
        ...
        args = self._list_by_endpoint_deprecated_mapped_args(
            app_id=app_id,
            msg_id=msg_id,
        ...
        return await self._alist_by_endpoint_deprecated_oapg(
    ...
    def list_by_endpoint_deprecated(
        ...
        return self._list_by_endpoint_deprecated_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class ListByEndpointDeprecated(BaseApi):
    ...
    async def alist_by_endpoint_deprecated(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ListResponseMessageAttemptEndpointOutPydantic:
        raw_response = await self.raw.alist_by_endpoint_deprecated(
            app_id=app_id,
            msg_id=msg_id,
            endpoint_id=endpoint_id,
            limit=limit,
        ...
        if validate:
            return ListResponseMessageAttemptEndpointOutPydantic(**raw_response.body)
        return api_client.construct_model_instance(ListResponseMessageAttemptEndpointOutPydantic, raw_response.body)
    ...
    def list_by_endpoint_deprecated(
        ...
        raw_response = self.raw.list_by_endpoint_deprecated(
            app_id=app_id,
            msg_id=msg_id,
            endpoint_id=endpoint_id,
            limit=limit,
