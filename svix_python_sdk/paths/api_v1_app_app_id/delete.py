...
class RemoveAppRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aremove_app(
        self,
        app_id: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._remove_app_mapped_args(
            app_id=app_id,
        )
        return await self._aremove_app_oapg(
    ...
    def remove_app(
        ...
        return self._remove_app_oapg(
            path_params=args.path,
        )

class RemoveApp(BaseApi):
    ...
    async def aremove_app(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aremove_app(
            app_id=app_id,
            **kwargs,
        )
    ...
    def remove_app(
        ...
        raw_response = self.raw.remove_app(
            app_id=app_id,
        )
