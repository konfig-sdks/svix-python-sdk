...
class UpdateAppRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aupdate_app(
        self,
        name: str,
        app_id: str,
        rate_limit: typing.Optional[typing.Optional[int]] = None,
        ...
        **kwargs,
        ...
        args = self._update_app_mapped_args(
            name=name,
            app_id=app_id,
        ...
        return await self._aupdate_app_oapg(
            body=args.body,
...
class UpdateApp(BaseApi):
    ...
    async def aupdate_app(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aupdate_app(
            name=name,
            app_id=app_id,
            rate_limit=rate_limit,
            uid=uid,
    ...
    def update_app(
        ...
        raw_response = self.raw.update_app(
            name=name,
            app_id=app_id,
            rate_limit=rate_limit,
            uid=uid,
