...
from svix_python_sdk.model.integration_key_out import IntegrationKeyOut as IntegrationKeyOutSchema

from svix_python_sdk.type.http_error_out import HttpErrorOut
from svix_python_sdk.type.integration_key_out import IntegrationKeyOut
...
from svix_python_sdk.pydantic.integration_key_out import IntegrationKeyOut as IntegrationKeyOutPydantic
...
SchemaFor200ResponseBodyApplicationJson = IntegrationKeyOutSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: IntegrationKeyOut
...
class BaseApi(api_client.Api):
    ...
    def _rotate_integration_key_mapped_args(
        self,
        app_id: str,
        integ_id: str,
    ...
    async def _arotate_integration_key_oapg(
        self,
    ...
    def _rotate_integration_key_oapg(
        self,
            header_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class RotateIntegrationKeyRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def arotate_integration_key(
        self,
        app_id: str,
        integ_id: str,
        idempotency_key: typing.Optional[str] = None,
        **kwargs,
        ...
        args = self._rotate_integration_key_mapped_args(
            app_id=app_id,
            integ_id=integ_id,
            idempotency_key=idempotency_key,
        )
        return await self._arotate_integration_key_oapg(
    ...
    def rotate_integration_key(
        ...
        return self._rotate_integration_key_oapg(
            header_params=args.header,
            path_params=args.path,
        )

class RotateIntegrationKey(BaseApi):
    ...
    async def arotate_integration_key(
        ...
        validate: bool = False,
        **kwargs,
    ) -> IntegrationKeyOutPydantic:
        raw_response = await self.raw.arotate_integration_key(
            app_id=app_id,
            integ_id=integ_id,
            idempotency_key=idempotency_key,
            **kwargs,
        ...
        if validate:
            return IntegrationKeyOutPydantic(**raw_response.body)
        return api_client.construct_model_instance(IntegrationKeyOutPydantic, raw_response.body)
    ...
    def rotate_integration_key(
        ...
        raw_response = self.raw.rotate_integration_key(
            app_id=app_id,
            integ_id=integ_id,
            idempotency_key=idempotency_key,
        )
