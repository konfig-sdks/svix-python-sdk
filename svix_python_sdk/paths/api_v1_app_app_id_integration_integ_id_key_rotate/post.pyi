...
class RotateKeyRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def arotate_key(
        self,
        app_id: str,
        integ_id: str,
        idempotency_key: typing.Optional[str] = None,
        **kwargs,
        ...
        args = self._rotate_key_mapped_args(
            app_id=app_id,
            integ_id=integ_id,
            idempotency_key=idempotency_key,
        )
        return await self._arotate_key_oapg(
    ...
    def rotate_key(
        ...
        return self._rotate_key_oapg(
            header_params=args.header,
            path_params=args.path,
        )

class RotateKey(BaseApi):
    ...
    async def arotate_key(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.arotate_key(
            app_id=app_id,
            integ_id=integ_id,
            idempotency_key=idempotency_key,
            **kwargs,
    ...
    def rotate_key(
        ...
        raw_response = self.raw.rotate_key(
            app_id=app_id,
            integ_id=integ_id,
            idempotency_key=idempotency_key,
        )
