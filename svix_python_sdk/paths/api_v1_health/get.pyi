...
class BaseApi(api_client.Api):
    ...
    def _check_server_status_mapped_args(
        self,
    ) -> api_client.MappedArgs:
        args: api_client.MappedArgs = api_client.MappedArgs()
        return args

    async def _acheck_server_status_oapg(
        self,
...
class CheckServerStatusRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def acheck_server_status(
        self,
        **kwargs,
    ) -> typing.Union[
        ApiResponseFor204Async,
        ...
        args = self._check_server_status_mapped_args(
        )
        return await self._acheck_server_status_oapg(
            **kwargs,
        )
    ...
    def check_server_status(
        ...
        return self._check_server_status_oapg(
        )

class CheckServerStatus(BaseApi):
    ...
    async def acheck_server_status(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.acheck_server_status(
            **kwargs,
        )
    ...
    def check_server_status(
        ...
        raw_response = self.raw.check_server_status(
        )
