...
from svix_python_sdk.model.status_code_class import StatusCodeClass as StatusCodeClassSchema
from svix_python_sdk.model.list_response_message_attempt_out import ListResponseMessageAttemptOut as ListResponseMessageAttemptOutSchema

from svix_python_sdk.type.status_code_class import StatusCodeClass
from svix_python_sdk.type.http_error_out import HttpErrorOut
from svix_python_sdk.type.list_response_message_attempt_out import ListResponseMessageAttemptOut
...
from svix_python_sdk.pydantic.status_code_class import StatusCodeClass as StatusCodeClassPydantic
...
from svix_python_sdk.pydantic.list_response_message_attempt_out import ListResponseMessageAttemptOut as ListResponseMessageAttemptOutPydantic
...
StatusCodeClassSchema = StatusCodeClassSchema
...
SchemaFor200ResponseBodyApplicationJson = ListResponseMessageAttemptOutSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ListResponseMessageAttemptOut
...
class BaseApi(api_client.Api):
    ...
    def _list_by_msg_attempted_destinations_0_mapped_args(
        self,
        app_id: str,
        msg_id: str,
        limit: typing.Optional[int] = None,
        iterator: typing.Optional[typing.Optional[str]] = None,
        endpoint_id: typing.Optional[typing.Optional[str]] = None,
        ...
        if endpoint_id is not None:
            _query_params["endpoint_id"] = endpoint_id
        ...
        if status_code_class is not None:
            _query_params["status_code_class"] = status_code_class
    ...
    async def _alist_by_msg_attempted_destinations_0_oapg(
        self,
    ...
    def _list_by_msg_attempted_destinations_0_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class ListByMsgAttemptedDestinations0Raw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @api_client.DeprecationWarningOnce(prefix="message_attempt")
    async def alist_by_msg_attempted_destinations_0(
        self,
        app_id: str,
        msg_id: str,
        limit: typing.Optional[int] = None,
        ...
        **kwargs,
        ...
        args = self._list_by_msg_attempted_destinations_0_mapped_args(
            app_id=app_id,
            msg_id=msg_id,
            limit=limit,
            iterator=iterator,
        ...
        return await self._alist_by_msg_attempted_destinations_0_oapg(
    ...
    @api_client.DeprecationWarningOnce(prefix="message_attempt")
    def list_by_msg_attempted_destinations_0(
        self,
        app_id: str,
        msg_id: str,
        limit: typing.Optional[int] = None,
        ...
        return self._list_by_msg_attempted_destinations_0_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class ListByMsgAttemptedDestinations0(BaseApi):
    ...
    async def alist_by_msg_attempted_destinations_0(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ListResponseMessageAttemptOutPydantic:
        raw_response = await self.raw.alist_by_msg_attempted_destinations_0(
            app_id=app_id,
            msg_id=msg_id,
            limit=limit,
            iterator=iterator,
        ...
        if validate:
            return ListResponseMessageAttemptOutPydantic(**raw_response.body)
        return api_client.construct_model_instance(ListResponseMessageAttemptOutPydantic, raw_response.body)
    ...
    def list_by_msg_attempted_destinations_0(
        ...
        raw_response = self.raw.list_by_msg_attempted_destinations_0(
            app_id=app_id,
            msg_id=msg_id,
            limit=limit,
            iterator=iterator,
