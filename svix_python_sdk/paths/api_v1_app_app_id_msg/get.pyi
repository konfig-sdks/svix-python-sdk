...
from svix_python_sdk.model.list_response_message_out import ListResponseMessageOut as ListResponseMessageOutSchema

from svix_python_sdk.type.http_error_out import HttpErrorOut
from svix_python_sdk.type.list_response_message_out import ListResponseMessageOut
from svix_python_sdk.type.http_validation_error import HTTPValidationError

from ...api_client import Dictionary
from svix_python_sdk.pydantic.list_response_message_out import ListResponseMessageOut as ListResponseMessageOutPydantic
...
SchemaFor200ResponseBodyApplicationJson = ListResponseMessageOutSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ListResponseMessageOut
...
class ListAllMessages(BaseApi):
    ...
    async def alist_all_messages(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ListResponseMessageOutPydantic:
        ...
        if validate:
            return ListResponseMessageOutPydantic(**raw_response.body)
        return api_client.construct_model_instance(ListResponseMessageOutPydantic, raw_response.body)
