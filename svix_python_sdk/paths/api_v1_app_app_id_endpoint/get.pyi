...
from svix_python_sdk.model.list_response_endpoint_out import ListResponseEndpointOut as ListResponseEndpointOutSchema

from svix_python_sdk.type.http_error_out import HttpErrorOut
from svix_python_sdk.type.list_response_endpoint_out import ListResponseEndpointOut
...
from svix_python_sdk.pydantic.list_response_endpoint_out import ListResponseEndpointOut as ListResponseEndpointOutPydantic
...
SchemaFor200ResponseBodyApplicationJson = ListResponseEndpointOutSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: ListResponseEndpointOut
...
class ListEndpoints(BaseApi):
    ...
    async def alist_endpoints(
        ...
        validate: bool = False,
        **kwargs,
    ) -> ListResponseEndpointOutPydantic:
        ...
        if validate:
            return ListResponseEndpointOutPydantic(**raw_response.body)
        return api_client.construct_model_instance(ListResponseEndpointOutPydantic, raw_response.body)
