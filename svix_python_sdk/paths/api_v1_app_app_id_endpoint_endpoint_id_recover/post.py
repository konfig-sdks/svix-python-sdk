...
from svix_python_sdk.model.recover_in import RecoverIn as RecoverInSchema
from svix_python_sdk.model.recover_out import RecoverOut as RecoverOutSchema
...
from svix_python_sdk.type.recover_in import RecoverIn
from svix_python_sdk.type.recover_out import RecoverOut

from ...api_client import Dictionary
from svix_python_sdk.pydantic.recover_out import RecoverOut as RecoverOutPydantic
from svix_python_sdk.pydantic.http_error_out import HttpErrorOut as HttpErrorOutPydantic
from svix_python_sdk.pydantic.recover_in import RecoverIn as RecoverInPydantic
...
# body param
SchemaForRequestBodyApplicationJson = RecoverInSchema
...
SchemaFor202ResponseBodyApplicationJson = RecoverOutSchema
...
class BaseApi(api_client.Api):
    ...
    def _resend_failed_webhooks_mapped_args(
        self,
        since: datetime,
        app_id: str,
        endpoint_id: str,
    ...
    async def _aresend_failed_webhooks_oapg(
        self,
    ...
    def _resend_failed_webhooks_oapg(
        self,
        body: typing.Any = None,
            header_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
...
class ResendFailedWebhooksRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aresend_failed_webhooks(
        self,
        since: datetime,
        app_id: str,
        endpoint_id: str,
        ...
        **kwargs,
        ...
        args = self._resend_failed_webhooks_mapped_args(
            since=since,
            app_id=app_id,
        ...
        return await self._aresend_failed_webhooks_oapg(
            body=args.body,
    ...
    def resend_failed_webhooks(
        ...
        return self._resend_failed_webhooks_oapg(
            body=args.body,
            header_params=args.header,
            path_params=args.path,
        )

class ResendFailedWebhooks(BaseApi):
    ...
    async def aresend_failed_webhooks(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aresend_failed_webhooks(
            since=since,
            app_id=app_id,
            endpoint_id=endpoint_id,
            until=until,
        ...
        if validate:
            return RecoverOutPydantic(**raw_response.body)
        return api_client.construct_model_instance(RecoverOutPydantic, raw_response.body)
    ...
    def resend_failed_webhooks(
        ...
        raw_response = self.raw.resend_failed_webhooks(
            since=since,
            app_id=app_id,
            endpoint_id=endpoint_id,
            until=until,
