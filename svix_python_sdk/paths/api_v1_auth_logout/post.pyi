...
class LogoutTokenRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def alogout_token(
        self,
        idempotency_key: typing.Optional[str] = None,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._logout_token_mapped_args(
            idempotency_key=idempotency_key,
        )
        return await self._alogout_token_oapg(
    ...
    def logout_token(
        ...
        return self._logout_token_oapg(
            header_params=args.header,
        )

class LogoutToken(BaseApi):
    ...
    async def alogout_token(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.alogout_token(
            idempotency_key=idempotency_key,
            **kwargs,
        )
    ...
    def logout_token(
        ...
        raw_response = self.raw.logout_token(
            idempotency_key=idempotency_key,
        )
