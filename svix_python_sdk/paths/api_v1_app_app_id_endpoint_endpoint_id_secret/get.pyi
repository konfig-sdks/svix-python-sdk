...
from svix_python_sdk.model.endpoint_secret_out import EndpointSecretOut as EndpointSecretOutSchema

from svix_python_sdk.type.http_error_out import HttpErrorOut
from svix_python_sdk.type.endpoint_secret_out import EndpointSecretOut
...
from svix_python_sdk.pydantic.endpoint_secret_out import EndpointSecretOut as EndpointSecretOutPydantic
...
SchemaFor200ResponseBodyApplicationJson = EndpointSecretOutSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: EndpointSecretOut
...
class BaseApi(api_client.Api):
    ...
    def _get_signing_secret_mapped_args(
        self,
        app_id: str,
        endpoint_id: str,
    ...
    async def _aget_signing_secret_oapg(
        self,
...
class GetSigningSecretRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_signing_secret(
        self,
        app_id: str,
        endpoint_id: str,
        **kwargs,
        ...
        args = self._get_signing_secret_mapped_args(
            app_id=app_id,
            endpoint_id=endpoint_id,
        )
        return await self._aget_signing_secret_oapg(
    ...
    def get_signing_secret(
        ...
        return self._get_signing_secret_oapg(
            path_params=args.path,
        )

class GetSigningSecret(BaseApi):
    ...
    async def aget_signing_secret(
        ...
        validate: bool = False,
        **kwargs,
    ) -> EndpointSecretOutPydantic:
        raw_response = await self.raw.aget_signing_secret(
            app_id=app_id,
            endpoint_id=endpoint_id,
            **kwargs,
        )
        if validate:
            return EndpointSecretOutPydantic(**raw_response.body)
        return api_client.construct_model_instance(EndpointSecretOutPydantic, raw_response.body)
    ...
    def get_signing_secret(
        ...
        raw_response = self.raw.get_signing_secret(
            app_id=app_id,
            endpoint_id=endpoint_id,
        )
        if validate:
