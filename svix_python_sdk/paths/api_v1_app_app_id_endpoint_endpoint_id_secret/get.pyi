...
class GetSecretRaw(BaseApi):
    ...
    async def aget_secret(
        ...
        **kwargs,
        ...
        args = self._get_secret_mapped_args(
            app_id=app_id,
            endpoint_id=endpoint_id,
        )
        return await self._aget_secret_oapg(
...
class GetSecret(BaseApi):
    ...
    async def aget_secret(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_secret(
            app_id=app_id,
            endpoint_id=endpoint_id,
            **kwargs,
        )
    ...
    def get_secret(
        ...
        raw_response = self.raw.get_secret(
            app_id=app_id,
            endpoint_id=endpoint_id,
        )
        if validate:
