...
class GetEndpointRaw(BaseApi):
    ...
    async def aget_endpoint(
        ...
        **kwargs,
        ...
        args = self._get_endpoint_mapped_args(
            app_id=app_id,
            endpoint_id=endpoint_id,
        )
        return await self._aget_endpoint_oapg(
    ...
    def get_endpoint(
        ...
        return self._get_endpoint_oapg(
            path_params=args.path,
        )

class GetEndpoint(BaseApi):
    ...
    async def aget_endpoint(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_endpoint(
            app_id=app_id,
            endpoint_id=endpoint_id,
            **kwargs,
        )
    ...
    def get_endpoint(
        ...
        raw_response = self.raw.get_endpoint(
            app_id=app_id,
            endpoint_id=endpoint_id,
        )
        if validate:
