...
from svix_python_sdk.model.replay_in import ReplayIn as ReplayInSchema
...
from svix_python_sdk.model.replay_out import ReplayOut as ReplayOutSchema

from svix_python_sdk.type.http_error_out import HttpErrorOut
from svix_python_sdk.type.replay_out import ReplayOut
from svix_python_sdk.type.http_validation_error import HTTPValidationError
from svix_python_sdk.type.replay_in import ReplayIn

from ...api_client import Dictionary
from svix_python_sdk.pydantic.replay_out import ReplayOut as ReplayOutPydantic
from svix_python_sdk.pydantic.replay_in import ReplayIn as ReplayInPydantic
...
# body param
SchemaForRequestBodyApplicationJson = ReplayInSchema
...
SchemaFor202ResponseBodyApplicationJson = ReplayOutSchema
...
class BaseApi(api_client.Api):
    ...
    def _replay_missing_webhooks_mapped_args(
        self,
        since: datetime,
        app_id: str,
        endpoint_id: str,
        until: typing.Optional[typing.Optional[datetime]] = None,
    ...
    async def _areplay_missing_webhooks_oapg(
        self,
    ...
    def _replay_missing_webhooks_oapg(
        self,
        body: typing.Any = None,
            header_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
...
class ReplayMissingWebhooksRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def areplay_missing_webhooks(
        self,
        since: datetime,
        app_id: str,
        endpoint_id: str,
        ...
        **kwargs,
        ...
        args = self._replay_missing_webhooks_mapped_args(
            since=since,
            app_id=app_id,
        ...
        return await self._areplay_missing_webhooks_oapg(
            body=args.body,
    ...
    def replay_missing_webhooks(
        ...
        return self._replay_missing_webhooks_oapg(
            body=args.body,
            header_params=args.header,
            path_params=args.path,
        )

class ReplayMissingWebhooks(BaseApi):
    ...
    async def areplay_missing_webhooks(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.areplay_missing_webhooks(
            since=since,
            app_id=app_id,
            endpoint_id=endpoint_id,
            until=until,
        ...
        if validate:
            return ReplayOutPydantic(**raw_response.body)
        return api_client.construct_model_instance(ReplayOutPydantic, raw_response.body)
    ...
    def replay_missing_webhooks(
        ...
        raw_response = self.raw.replay_missing_webhooks(
            since=since,
            app_id=app_id,
            endpoint_id=endpoint_id,
            until=until,
