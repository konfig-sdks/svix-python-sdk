...
from svix_python_sdk.model.background_task_out import BackgroundTaskOut as BackgroundTaskOutSchema

from svix_python_sdk.type.http_error_out import HttpErrorOut
from svix_python_sdk.type.background_task_out import BackgroundTaskOut
...
from svix_python_sdk.pydantic.background_task_out import BackgroundTaskOut as BackgroundTaskOutPydantic
...
SchemaFor200ResponseBodyApplicationJson = BackgroundTaskOutSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: BackgroundTaskOut
...
class BaseApi(api_client.Api):
    ...
    def _get_task_by_id_mapped_args(
        self,
        task_id: str,
    ...
    async def _aget_task_by_id_oapg(
        self,
...
class GetTaskByIdRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_task_by_id(
        self,
        task_id: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._get_task_by_id_mapped_args(
            task_id=task_id,
        )
        return await self._aget_task_by_id_oapg(
...
class GetTaskById(BaseApi):
    ...
    async def aget_task_by_id(
        ...
        validate: bool = False,
        **kwargs,
    ) -> BackgroundTaskOutPydantic:
        raw_response = await self.raw.aget_task_by_id(
            task_id=task_id,
            **kwargs,
        )
        if validate:
            return BackgroundTaskOutPydantic(**raw_response.body)
        return api_client.construct_model_instance(BackgroundTaskOutPydantic, raw_response.body)
    ...
    def get_task_by_id(
        ...
        raw_response = self.raw.get_task_by_id(
            task_id=task_id,
        )
        if validate:
            return BackgroundTaskOutPydantic(**raw_response.body)
