...
class BaseApi(api_client.Api):
    ...
    def _get_event_type_mapped_args(
        self,
        event_type_name: str,
    ...
    async def _aget_event_type_oapg(
        self,
...
class GetEventTypeRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_event_type(
        self,
        event_type_name: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._get_event_type_mapped_args(
            event_type_name=event_type_name,
        )
        return await self._aget_event_type_oapg(
    ...
    def get_event_type(
        ...
        return self._get_event_type_oapg(
            path_params=args.path,
        )

class GetEventType(BaseApi):
    ...
    async def aget_event_type(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_event_type(
            event_type_name=event_type_name,
            **kwargs,
        )
        if validate:
    ...
    def get_event_type(
        ...
        raw_response = self.raw.get_event_type(
            event_type_name=event_type_name,
        )
        if validate:
            return EventTypeOutPydantic(**raw_response.body)
