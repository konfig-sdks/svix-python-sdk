...
class EventTypeOut(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def schemas() -> typing.Type['EventTypeOutSchemas']:
                return EventTypeOutSchemas
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["schemas"]) -> 'EventTypeOutSchemas': ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["description", "name", "createdAt", "updatedAt", "archived", "schemas", "featureFlag", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["schemas"]) -> typing.Union['EventTypeOutSchemas', schemas.Unset]: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["description", "name", "createdAt", "updatedAt", "archived", "schemas", "featureFlag", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        schemas: typing.Union['EventTypeOutSchemas', schemas.Unset] = schemas.unset,
