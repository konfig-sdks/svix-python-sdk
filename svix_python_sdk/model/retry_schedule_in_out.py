...
class RetryScheduleInOut(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def retrySchedule() -> typing.Type['RetrySchedule']:
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["retrySchedule"]) -> 'RetrySchedule': ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["retrySchedule", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["retrySchedule"]) -> typing.Union['RetrySchedule', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["retrySchedule", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        retrySchedule: typing.Union['RetrySchedule', schemas.Unset] = schemas.unset,
