...
class EndpointHeadersIn(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def headers() -> typing.Type['EndpointHeadersInHeaders']:
                return EndpointHeadersInHeaders
            __annotations__ = {
                "headers": headers,
            }
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["headers"]) -> 'EndpointHeadersInHeaders': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["headers"]) -> 'EndpointHeadersInHeaders': ...
