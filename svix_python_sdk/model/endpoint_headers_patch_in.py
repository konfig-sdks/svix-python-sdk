...
class EndpointHeadersPatchIn(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def headers() -> typing.Type['EndpointHeadersPatchInHeaders']:
                return EndpointHeadersPatchInHeaders
            __annotations__ = {
                "headers": headers,
            }
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["headers"]) -> 'EndpointHeadersPatchInHeaders': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["headers"]) -> 'EndpointHeadersPatchInHeaders': ...
