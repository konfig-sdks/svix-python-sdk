...
class EndpointTransformationSimulateIn(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def channels() -> typing.Type['EndpointTransformationSimulateInChannels']:
                return EndpointTransformationSimulateInChannels
            __annotations__ = {
                "code": code,
                "eventType": eventType,
                "payload": payload,
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["channels"]) -> 'EndpointTransformationSimulateInChannels': ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["code", "eventType", "payload", "channels", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["channels"]) -> typing.Union['EndpointTransformationSimulateInChannels', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["code", "eventType", "payload", "channels", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        channels: typing.Union['EndpointTransformationSimulateInChannels', schemas.Unset] = schemas.unset,
