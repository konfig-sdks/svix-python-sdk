...
class EndpointUpdate(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def filterTypes() -> typing.Type['EndpointUpdateFilterTypes']:
                return EndpointUpdateFilterTypes
        
            @staticmethod
            def channels() -> typing.Type['EndpointUpdateChannels']:
                return EndpointUpdateChannels
        
            @staticmethod
            def metadata() -> typing.Type['EndpointUpdateMetadata']:
                return EndpointUpdateMetadata
            __annotations__ = {
                "url": url,
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["filterTypes"]) -> 'EndpointUpdateFilterTypes': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["channels"]) -> 'EndpointUpdateChannels': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["metadata"]) -> 'EndpointUpdateMetadata': ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["url", "description", "version", "rateLimit", "uid", "disabled", "filterTypes", "channels", "metadata", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["filterTypes"]) -> typing.Union['EndpointUpdateFilterTypes', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["channels"]) -> typing.Union['EndpointUpdateChannels', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["metadata"]) -> typing.Union['EndpointUpdateMetadata', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["url", "description", "version", "rateLimit", "uid", "disabled", "filterTypes", "channels", "metadata", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        filterTypes: typing.Union['EndpointUpdateFilterTypes', schemas.Unset] = schemas.unset,
        channels: typing.Union['EndpointUpdateChannels', schemas.Unset] = schemas.unset,
        metadata: typing.Union['EndpointUpdateMetadata', schemas.Unset] = schemas.unset,
        _configuration: typing.Optional[schemas.Configuration] = None,
