...
class EndpointStats(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            sending = schemas.Int64Schema
            fail = schemas.Int64Schema
            __annotations__ = {
                "success": success,
                "pending": pending,
                "sending": sending,
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["success", "pending", "sending", "fail", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["success", "pending", "sending", "fail", ], str]):
