...
class AppUsageStatsIn(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def appIds() -> typing.Type['AppUsageStatsInAppIds']:
                return AppUsageStatsInAppIds
            __annotations__ = {
                "since": since,
                "until": until,
                "appIds": appIds,
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["appIds"]) -> 'AppUsageStatsInAppIds': ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["since", "until", "appIds", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["appIds"]) -> typing.Union['AppUsageStatsInAppIds', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["since", "until", "appIds", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        appIds: typing.Union['AppUsageStatsInAppIds', schemas.Unset] = schemas.unset,
