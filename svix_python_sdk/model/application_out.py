...
class ApplicationOut(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def metadata() -> typing.Type['ApplicationOutMetadata']:
                return ApplicationOutMetadata
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["metadata"]) -> 'ApplicationOutMetadata': ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["name", "id", "createdAt", "updatedAt", "metadata", "uid", "rateLimit", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["metadata"]) -> 'ApplicationOutMetadata': ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["name", "id", "createdAt", "updatedAt", "metadata", "uid", "rateLimit", ], str]):
