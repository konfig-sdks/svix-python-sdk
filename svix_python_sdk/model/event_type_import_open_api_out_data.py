...
class EventTypeImportOpenApiOutData(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def modified() -> typing.Type['EventTypeImportOpenApiOutDataModified']:
                return EventTypeImportOpenApiOutDataModified
            __annotations__ = {
                "modified": modified,
            }
    
    modified: 'EventTypeImportOpenApiOutDataModified'
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["modified"]) -> 'EventTypeImportOpenApiOutDataModified': ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["modified", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["modified"]) -> 'EventTypeImportOpenApiOutDataModified': ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["modified", ], str]):
