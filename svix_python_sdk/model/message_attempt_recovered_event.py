...
class MessageAttemptRecoveredEvent(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def data() -> typing.Type['MessageAttemptRecoveredEventData']:
            ...
            class type(
                ...
                class MetaOapg:
                    enum_value_to_name = {
                        "message.attempt.recovered": "MESSAGE_ATTEMPT_RECOVERED",
                    }
                
                @schemas.classproperty
                def MESSAGE_ATTEMPT_RECOVERED(cls):
                    return cls("message.attempt.recovered")
            __annotations__ = {
                "data": data,
                "type": type,
            }
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["data"]) -> 'MessageAttemptRecoveredEventData': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["data"]) -> 'MessageAttemptRecoveredEventData': ...
