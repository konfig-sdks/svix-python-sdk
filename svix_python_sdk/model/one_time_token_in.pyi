...
class OneTimeTokenIn(
    ...
    class MetaOapg:
        ...
        class properties:
            oneTimeToken = schemas.StrSchema
            __annotations__ = {
                "oneTimeToken": oneTimeToken,
            }
    
    oneTimeToken: MetaOapg.properties.oneTimeToken
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["oneTimeToken"]) -> MetaOapg.properties.oneTimeToken: ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["oneTimeToken", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["oneTimeToken"]) -> MetaOapg.properties.oneTimeToken: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["oneTimeToken", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        oneTimeToken: typing.Union[MetaOapg.properties.oneTimeToken, str, ],
