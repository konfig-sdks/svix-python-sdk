...
class EndpointTransformationIn(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["code", "enabled", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["code", "enabled", ], str]):
