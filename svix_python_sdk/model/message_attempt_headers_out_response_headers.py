...
class MessageAttemptHeadersOutResponseHeaders(
    schemas.ListBase,
    schemas.NoneBase,
    schemas.Schema,
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['MessageAttemptHeadersOutResponseHeadersItem']:
            return MessageAttemptHeadersOutResponseHeadersItem
    ...
    ) -> 'MessageAttemptHeadersOutResponseHeaders':
