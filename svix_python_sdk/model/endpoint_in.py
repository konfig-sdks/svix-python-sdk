...
class EndpointIn(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def filterTypes() -> typing.Type['EndpointInFilterTypes']:
                return EndpointInFilterTypes
        
            @staticmethod
            def channels() -> typing.Type['EndpointInChannels']:
                return EndpointInChannels
            ...
            class secret(
                ...
                class MetaOapg:
                    regex=[{
                        'pattern': r'^(whsec_)?[a-zA-Z0-9+/=]{32,100}$',
                    }]
            ...
            @staticmethod
            def metadata() -> typing.Type['EndpointInMetadata']:
                return EndpointInMetadata
            __annotations__ = {
                "url": url,
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["filterTypes"]) -> 'EndpointInFilterTypes': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["channels"]) -> 'EndpointInChannels': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["secret"]) -> MetaOapg.properties.secret: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["metadata"]) -> 'EndpointInMetadata': ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["url", "description", "version", "rateLimit", "uid", "disabled", "filterTypes", "channels", "secret", "metadata", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["filterTypes"]) -> typing.Union['EndpointInFilterTypes', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["channels"]) -> typing.Union['EndpointInChannels', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["secret"]) -> typing.Union[MetaOapg.properties.secret, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["metadata"]) -> typing.Union['EndpointInMetadata', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["url", "description", "version", "rateLimit", "uid", "disabled", "filterTypes", "channels", "secret", "metadata", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        filterTypes: typing.Union['EndpointInFilterTypes', schemas.Unset] = schemas.unset,
        channels: typing.Union['EndpointInChannels', schemas.Unset] = schemas.unset,
        secret: typing.Union[MetaOapg.properties.secret, None, str, schemas.Unset] = schemas.unset,
        metadata: typing.Union['EndpointInMetadata', schemas.Unset] = schemas.unset,
        _configuration: typing.Optional[schemas.Configuration] = None,
