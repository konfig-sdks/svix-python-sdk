...
class OauthPayloadOut(
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["incomingWebhookUrl"]) -> MetaOapg.properties.incomingWebhookUrl: ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["error", "incomingWebhookUrl", "channel", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["incomingWebhookUrl"]) -> typing.Union[MetaOapg.properties.incomingWebhookUrl, schemas.Unset]: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["error", "incomingWebhookUrl", "channel", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        incomingWebhookUrl: typing.Union[MetaOapg.properties.incomingWebhookUrl, None, str, schemas.Unset] = schemas.unset,
