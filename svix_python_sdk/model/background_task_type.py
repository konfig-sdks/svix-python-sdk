...
class BackgroundTaskType(
    ...
    class MetaOapg:
        enum_value_to_name = {
            "endpoint.replay": "ENDPOINT_REPLAY",
            "endpoint.recover": "ENDPOINT_RECOVER",
            "application.stats": "APPLICATION_STATS",
            "message.broadcast": "MESSAGE_BROADCAST",
            "sdk.generate": "SDK_GENERATE",
            "event-type.aggregate": "EVENTTYPE_AGGREGATE",
        }
    ...
    @schemas.classproperty
    def ENDPOINT_RECOVER(cls):
        return cls("endpoint.recover")
    
    @schemas.classproperty
    def APPLICATION_STATS(cls):
        return cls("application.stats")
    
    @schemas.classproperty
    def MESSAGE_BROADCAST(cls):
        return cls("message.broadcast")
    
    @schemas.classproperty
    def SDK_GENERATE(cls):
        return cls("sdk.generate")
    
    @schemas.classproperty
    def EVENTTYPE_AGGREGATE(cls):
        return cls("event-type.aggregate")
