...
from svix_python_sdk.type.endpoint_disabled_event_data import EndpointDisabledEventData

class RequiredEndpointDisabledEvent(TypedDict):
    data: EndpointDisabledEventData

    type: str

class OptionalEndpointDisabledEvent(TypedDict, total=False):
    pass

class EndpointDisabledEvent(RequiredEndpointDisabledEvent, OptionalEndpointDisabledEvent):
    pass
