...
class RequiredIntegrationUpdate(TypedDict):
    name: str

class OptionalIntegrationUpdate(TypedDict, total=False):
    pass

class IntegrationUpdate(RequiredIntegrationUpdate, OptionalIntegrationUpdate):
    pass
