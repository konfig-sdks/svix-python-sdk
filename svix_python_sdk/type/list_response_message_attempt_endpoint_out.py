...
from svix_python_sdk.type.message_attempt_endpoint_out import MessageAttemptEndpointOut

class RequiredListResponseMessageAttemptEndpointOut(TypedDict):
    data: typing.List[MessageAttemptEndpointOut]

    done: bool

class OptionalListResponseMessageAttemptEndpointOut(TypedDict, total=False):
    iterator: typing.Optional[str]

    prevIterator: typing.Optional[str]

class ListResponseMessageAttemptEndpointOut(RequiredListResponseMessageAttemptEndpointOut, OptionalListResponseMessageAttemptEndpointOut):
    pass
