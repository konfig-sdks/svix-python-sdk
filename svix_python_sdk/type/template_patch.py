...
from svix_python_sdk.type.template_patch_filter_types import TemplatePatchFilterTypes
from svix_python_sdk.type.transformation_template_kind import TransformationTemplateKind

class RequiredTemplatePatch(TypedDict):
    pass

class OptionalTemplatePatch(TypedDict, total=False):
    description: str
    ...
    instructionsLink: typing.Optional[str]

    filterTypes: TemplatePatchFilterTypes

    transformation: str

    featureFlag: typing.Optional[str]

class TemplatePatch(RequiredTemplatePatch, OptionalTemplatePatch):
    pass
