...
class RequiredIntegrationOut(TypedDict):
    name: str
...
class OptionalIntegrationOut(TypedDict, total=False):
    pass

class IntegrationOut(RequiredIntegrationOut, OptionalIntegrationOut):
    pass
