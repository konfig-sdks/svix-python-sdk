...
class RequiredApplicationPatch(TypedDict):
    pass

class OptionalApplicationPatch(TypedDict, total=False):
    name: str
    ...
    metadata: ApplicationPatchMetadata

class ApplicationPatch(RequiredApplicationPatch, OptionalApplicationPatch):
    pass
