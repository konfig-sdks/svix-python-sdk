...
class RequiredEndpointDisabledEventData(TypedDict):
    # The app's ID
    appId: str
...
class OptionalEndpointDisabledEventData(TypedDict, total=False):
    # The app's UID
    appUid: typing.Optional[str]

    # The ep's UID
    endpointUid: typing.Optional[str]

class EndpointDisabledEventData(RequiredEndpointDisabledEventData, OptionalEndpointDisabledEventData):
    pass
