...
class RequiredAppPortalAccessOut(TypedDict):
    url: str

    token: str

class OptionalAppPortalAccessOut(TypedDict, total=False):
    pass

class AppPortalAccessOut(RequiredAppPortalAccessOut, OptionalAppPortalAccessOut):
    pass
