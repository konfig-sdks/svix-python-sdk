...
from svix_python_sdk.type.message_out_channels import MessageOutChannels
from svix_python_sdk.type.message_out_tags import MessageOutTags

class RequiredMessageOut(TypedDict):
...
class OptionalMessageOut(TypedDict, total=False):
    tags: MessageOutTags

    # Optional unique identifier for the message
    eventId: typing.Optional[str]

    channels: MessageOutChannels

class MessageOut(RequiredMessageOut, OptionalMessageOut):
    pass
