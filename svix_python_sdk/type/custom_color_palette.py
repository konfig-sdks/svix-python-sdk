...
class RequiredCustomColorPalette(TypedDict):
    pass

class OptionalCustomColorPalette(TypedDict, total=False):
    primary: typing.Optional[str]

    backgroundPrimary: typing.Optional[str]

    backgroundSecondary: typing.Optional[str]

    backgroundHover: typing.Optional[str]

    textPrimary: typing.Optional[str]

    textDanger: typing.Optional[str]

    interactiveAccent: typing.Optional[str]

    navigationAccent: typing.Optional[str]

    buttonPrimary: typing.Optional[str]

class CustomColorPalette(RequiredCustomColorPalette, OptionalCustomColorPalette):
    pass
