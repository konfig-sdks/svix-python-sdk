...
from svix_python_sdk.type.endpoint_message_out_channels import EndpointMessageOutChannels
from svix_python_sdk.type.endpoint_message_out_tags import EndpointMessageOutTags
from svix_python_sdk.type.message_status import MessageStatus

class RequiredEndpointMessageOut(TypedDict):
...
class OptionalEndpointMessageOut(TypedDict, total=False):
    tags: EndpointMessageOutTags

    nextAttempt: typing.Optional[datetime]

    # Optional unique identifier for the message
    eventId: typing.Optional[str]

    channels: EndpointMessageOutChannels

class EndpointMessageOut(RequiredEndpointMessageOut, OptionalEndpointMessageOut):
    pass
