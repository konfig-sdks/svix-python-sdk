...
from svix_python_sdk.type.transformation_simulate_in_channels import TransformationSimulateInChannels

class RequiredTransformationSimulateIn(TypedDict):
    code: str
...
class OptionalTransformationSimulateIn(TypedDict, total=False):
    channels: TransformationSimulateInChannels

class TransformationSimulateIn(RequiredTransformationSimulateIn, OptionalTransformationSimulateIn):
    pass
