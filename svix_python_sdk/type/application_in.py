...
class RequiredApplicationIn(TypedDict):
    name: str

class OptionalApplicationIn(TypedDict, total=False):
    rateLimit: typing.Optional[int]

    # Optional unique identifier for the application
    uid: typing.Optional[str]

    metadata: ApplicationInMetadata

class ApplicationIn(RequiredApplicationIn, OptionalApplicationIn):
    pass
