...
class RequiredEndpointUpdatedEventData(TypedDict):
    # The app's ID
    appId: str
...
class OptionalEndpointUpdatedEventData(TypedDict, total=False):
    # The app's UID
...
class EndpointUpdatedEventData(RequiredEndpointUpdatedEventData, OptionalEndpointUpdatedEventData):
    pass
