...
from svix_python_sdk.type.template_out import TemplateOut

class RequiredListResponseTemplateOut(TypedDict):
    data: typing.List[TemplateOut]

    done: bool

class OptionalListResponseTemplateOut(TypedDict, total=False):
    iterator: typing.Optional[str]

    prevIterator: typing.Optional[str]

class ListResponseTemplateOut(RequiredListResponseTemplateOut, OptionalListResponseTemplateOut):
    pass
