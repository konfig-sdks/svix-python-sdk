...
class RequiredEventTypePatch(TypedDict):
    pass

class OptionalEventTypePatch(TypedDict, total=False):
    description: str

    archived: bool

    schemas: EventTypePatchSchemas

    featureFlag: typing.Optional[str]

class EventTypePatch(RequiredEventTypePatch, OptionalEventTypePatch):
    pass
