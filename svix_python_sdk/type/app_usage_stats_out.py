...
class RequiredAppUsageStatsOut(TypedDict):
    id: str
...
class OptionalAppUsageStatsOut(TypedDict, total=False):
    pass

class AppUsageStatsOut(RequiredAppUsageStatsOut, OptionalAppUsageStatsOut):
    pass
