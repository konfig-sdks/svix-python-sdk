...
class RequiredEndpointTransformationOut(TypedDict):
    pass

class OptionalEndpointTransformationOut(TypedDict, total=False):
    code: typing.Optional[str]

    enabled: bool

class EndpointTransformationOut(RequiredEndpointTransformationOut, OptionalEndpointTransformationOut):
    pass
