...
from svix_python_sdk.type.message_attempt_trigger_type import MessageAttemptTriggerType
from svix_python_sdk.type.message_out import MessageOut
from svix_python_sdk.type.message_status import MessageStatus

class RequiredMessageAttemptEndpointOut(TypedDict):
    url: str
...
class OptionalMessageAttemptEndpointOut(TypedDict, total=False):
    msg: MessageOut

class MessageAttemptEndpointOut(RequiredMessageAttemptEndpointOut, OptionalMessageAttemptEndpointOut):
    pass
