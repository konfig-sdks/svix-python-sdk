...
from svix_python_sdk.type.border_radius_config import BorderRadiusConfig
from svix_python_sdk.type.font_size_config import FontSizeConfig

class RequiredCustomThemeOverride(TypedDict):
    pass

class OptionalCustomThemeOverride(TypedDict, total=False):
    borderRadius: BorderRadiusConfig

    fontSize: FontSizeConfig

class CustomThemeOverride(RequiredCustomThemeOverride, OptionalCustomThemeOverride):
    pass
