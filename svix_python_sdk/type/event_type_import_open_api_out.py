...
from svix_python_sdk.type.event_type_import_open_api_out_data import EventTypeImportOpenApiOutData

class RequiredEventTypeImportOpenApiOut(TypedDict):
    data: EventTypeImportOpenApiOutData

class OptionalEventTypeImportOpenApiOut(TypedDict, total=False):
    pass

class EventTypeImportOpenApiOut(RequiredEventTypeImportOpenApiOut, OptionalEventTypeImportOpenApiOut):
    pass
