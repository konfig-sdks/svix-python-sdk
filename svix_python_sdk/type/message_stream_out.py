...
class RequiredMessageStreamOut(TypedDict):
...
class OptionalMessageStreamOut(TypedDict, total=False):
    pass

class MessageStreamOut(RequiredMessageStreamOut, OptionalMessageStreamOut):
    pass
