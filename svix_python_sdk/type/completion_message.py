...
class RequiredCompletionMessage(TypedDict):
    content: str

    role: str

class OptionalCompletionMessage(TypedDict, total=False):
    pass

class CompletionMessage(RequiredCompletionMessage, OptionalCompletionMessage):
    pass
