...
class RequiredEndpointSecretRotateIn(TypedDict):
    pass

class OptionalEndpointSecretRotateIn(TypedDict, total=False):
...
class EndpointSecretRotateIn(RequiredEndpointSecretRotateIn, OptionalEndpointSecretRotateIn):
    pass
