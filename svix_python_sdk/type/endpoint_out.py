...
from svix_python_sdk.type.endpoint_out_channels import EndpointOutChannels
from svix_python_sdk.type.endpoint_out_filter_types import EndpointOutFilterTypes
from svix_python_sdk.type.endpoint_out_metadata import EndpointOutMetadata

class RequiredEndpointOut(TypedDict):
...
class OptionalEndpointOut(TypedDict, total=False):
    ...
    filterTypes: EndpointOutFilterTypes

    channels: EndpointOutChannels

class EndpointOut(RequiredEndpointOut, OptionalEndpointOut):
    pass
