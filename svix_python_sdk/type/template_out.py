...
from svix_python_sdk.type.template_out_filter_types import TemplateOutFilterTypes
from svix_python_sdk.type.transformation_template_kind import TransformationTemplateKind

class RequiredTemplateOut(TypedDict):
    description: str
...
class OptionalTemplateOut(TypedDict, total=False):
    instructionsLink: typing.Optional[str]

    filterTypes: TemplateOutFilterTypes

    featureFlag: typing.Optional[str]

class TemplateOut(RequiredTemplateOut, OptionalTemplateOut):
    pass
