...
class RequiredMessageRawPayloadOut(TypedDict):
    payload: str

class OptionalMessageRawPayloadOut(TypedDict, total=False):
    pass

class MessageRawPayloadOut(RequiredMessageRawPayloadOut, OptionalMessageRawPayloadOut):
    pass
