...
class RequiredListResponseEventTypeOut(TypedDict):
    data: typing.List[EventTypeOut]

    done: bool

class OptionalListResponseEventTypeOut(TypedDict, total=False):
    iterator: typing.Optional[str]

    prevIterator: typing.Optional[str]

class ListResponseEventTypeOut(RequiredListResponseEventTypeOut, OptionalListResponseEventTypeOut):
    pass
