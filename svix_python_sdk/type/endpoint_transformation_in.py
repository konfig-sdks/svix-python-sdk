...
class RequiredEndpointTransformationIn(TypedDict):
    pass

class OptionalEndpointTransformationIn(TypedDict, total=False):
    code: typing.Optional[str]

    enabled: bool

class EndpointTransformationIn(RequiredEndpointTransformationIn, OptionalEndpointTransformationIn):
    pass
