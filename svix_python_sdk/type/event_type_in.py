...
class RequiredEventTypeIn(TypedDict):
    description: str

    # The event type's name
    name: str

class OptionalEventTypeIn(TypedDict, total=False):
    archived: bool

    schemas: EventTypeInSchemas

    featureFlag: typing.Optional[str]

class EventTypeIn(RequiredEventTypeIn, OptionalEventTypeIn):
    pass
