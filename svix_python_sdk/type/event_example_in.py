...
class RequiredEventExampleIn(TypedDict):
    # The event type's name
    eventType: str

class OptionalEventExampleIn(TypedDict, total=False):
    pass

class EventExampleIn(RequiredEventExampleIn, OptionalEventExampleIn):
    pass
