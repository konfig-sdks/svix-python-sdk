...
class RequiredFontSizeConfig(TypedDict):
    pass

class OptionalFontSizeConfig(TypedDict, total=False):
    base: typing.Optional[int]

class FontSizeConfig(RequiredFontSizeConfig, OptionalFontSizeConfig):
    pass
