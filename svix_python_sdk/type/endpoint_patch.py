...
class RequiredEndpointPatch(TypedDict):
    pass

class OptionalEndpointPatch(TypedDict, total=False):
    description: str
    ...
    filterTypes: EndpointPatchFilterTypes

    channels: EndpointPatchChannels
    ...
    metadata: EndpointPatchMetadata

class EndpointPatch(RequiredEndpointPatch, OptionalEndpointPatch):
    pass
