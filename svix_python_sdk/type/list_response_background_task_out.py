...
class RequiredListResponseBackgroundTaskOut(TypedDict):
    data: typing.List[BackgroundTaskOut]

    done: bool

class OptionalListResponseBackgroundTaskOut(TypedDict, total=False):
    iterator: typing.Optional[str]

    prevIterator: typing.Optional[str]

class ListResponseBackgroundTaskOut(RequiredListResponseBackgroundTaskOut, OptionalListResponseBackgroundTaskOut):
    pass
