...
class RequiredEventTypeUpdate(TypedDict):
    description: str

class OptionalEventTypeUpdate(TypedDict, total=False):
    archived: bool

    schemas: EventTypeUpdateSchemas

    featureFlag: typing.Optional[str]

class EventTypeUpdate(RequiredEventTypeUpdate, OptionalEventTypeUpdate):
    pass
