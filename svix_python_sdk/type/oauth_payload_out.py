...
class RequiredOauthPayloadOut(TypedDict):
    pass

class OptionalOauthPayloadOut(TypedDict, total=False):
    error: typing.Optional[str]

    incomingWebhookUrl: typing.Optional[str]

    channel: typing.Optional[str]

class OauthPayloadOut(RequiredOauthPayloadOut, OptionalOauthPayloadOut):
    pass
