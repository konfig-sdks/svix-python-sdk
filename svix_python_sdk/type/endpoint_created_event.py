...
from svix_python_sdk.type.endpoint_created_event_data import EndpointCreatedEventData

class RequiredEndpointCreatedEvent(TypedDict):
    data: EndpointCreatedEventData

    type: str

class OptionalEndpointCreatedEvent(TypedDict, total=False):
    pass

class EndpointCreatedEvent(RequiredEndpointCreatedEvent, OptionalEndpointCreatedEvent):
    pass
