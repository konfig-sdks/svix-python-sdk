...
from svix_python_sdk.type.transformation_http_method import TransformationHttpMethod

class RequiredEndpointTransformationSimulateOut(TypedDict):
    url: str

    payload: str

class OptionalEndpointTransformationSimulateOut(TypedDict, total=False):
    method: TransformationHttpMethod

class EndpointTransformationSimulateOut(RequiredEndpointTransformationSimulateOut, OptionalEndpointTransformationSimulateOut):
    pass
