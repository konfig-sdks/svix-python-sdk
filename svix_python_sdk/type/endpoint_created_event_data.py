...
class RequiredEndpointCreatedEventData(TypedDict):
    # The app's ID
    appId: str
...
class OptionalEndpointCreatedEventData(TypedDict, total=False):
    # The app's UID
...
class EndpointCreatedEventData(RequiredEndpointCreatedEventData, OptionalEndpointCreatedEventData):
    pass
