...
from svix_python_sdk.type.border_radius_enum import BorderRadiusEnum

class RequiredBorderRadiusConfig(TypedDict):
    pass

class OptionalBorderRadiusConfig(TypedDict, total=False):
...
class BorderRadiusConfig(RequiredBorderRadiusConfig, OptionalBorderRadiusConfig):
    pass
