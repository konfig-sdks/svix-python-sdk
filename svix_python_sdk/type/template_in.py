...
from svix_python_sdk.type.template_in_filter_types import TemplateInFilterTypes
from svix_python_sdk.type.transformation_template_kind import TransformationTemplateKind

class RequiredTemplateIn(TypedDict):
    name: str
...
class OptionalTemplateIn(TypedDict, total=False):
    description: str
    ...
    filterTypes: TemplateInFilterTypes

    featureFlag: typing.Optional[str]

class TemplateIn(RequiredTemplateIn, OptionalTemplateIn):
    pass
