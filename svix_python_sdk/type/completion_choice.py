...
from svix_python_sdk.type.completion_message import CompletionMessage

class RequiredCompletionChoice(TypedDict):
...
class OptionalCompletionChoice(TypedDict, total=False):
    pass

class CompletionChoice(RequiredCompletionChoice, OptionalCompletionChoice):
    pass
