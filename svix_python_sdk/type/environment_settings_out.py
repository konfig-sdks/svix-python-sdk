...
class RequiredEnvironmentSettingsOut(TypedDict):
    pass

class OptionalEnvironmentSettingsOut(TypedDict, total=False):
...
class EnvironmentSettingsOut(RequiredEnvironmentSettingsOut, OptionalEnvironmentSettingsOut):
    pass
