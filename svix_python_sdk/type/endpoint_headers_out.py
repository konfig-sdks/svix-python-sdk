...
from svix_python_sdk.type.endpoint_headers_out_headers import EndpointHeadersOutHeaders
from svix_python_sdk.type.endpoint_headers_out_sensitive import EndpointHeadersOutSensitive

class RequiredEndpointHeadersOut(TypedDict):
    headers: EndpointHeadersOutHeaders

    sensitive: EndpointHeadersOutSensitive

class OptionalEndpointHeadersOut(TypedDict, total=False):
    pass

class EndpointHeadersOut(RequiredEndpointHeadersOut, OptionalEndpointHeadersOut):
    pass
