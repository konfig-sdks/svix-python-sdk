...
class RequiredListResponseIntegrationOut(TypedDict):
    data: typing.List[IntegrationOut]

    done: bool

class OptionalListResponseIntegrationOut(TypedDict, total=False):
    iterator: typing.Optional[str]

    prevIterator: typing.Optional[str]

class ListResponseIntegrationOut(RequiredListResponseIntegrationOut, OptionalListResponseIntegrationOut):
    pass
