...
class RequiredListResponseEndpointOut(TypedDict):
    data: typing.List[EndpointOut]

    done: bool

class OptionalListResponseEndpointOut(TypedDict, total=False):
    iterator: typing.Optional[str]

    prevIterator: typing.Optional[str]

class ListResponseEndpointOut(RequiredListResponseEndpointOut, OptionalListResponseEndpointOut):
    pass
