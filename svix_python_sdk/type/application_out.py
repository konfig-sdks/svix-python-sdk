...
from svix_python_sdk.type.application_out_metadata import ApplicationOutMetadata

class RequiredApplicationOut(TypedDict):
    name: str
...
class OptionalApplicationOut(TypedDict, total=False):
    # The app's UID
    uid: typing.Optional[str]

    rateLimit: typing.Optional[int]

class ApplicationOut(RequiredApplicationOut, OptionalApplicationOut):
    pass
