...
from svix_python_sdk.type.settings_in import SettingsIn

class RequiredEnvironmentIn(TypedDict):
    version: int

    createdAt: datetime

class OptionalEnvironmentIn(TypedDict, total=False):
    eventTypes: typing.Optional[typing.List[EventTypeIn]]

    settings: SettingsIn

class EnvironmentIn(RequiredEnvironmentIn, OptionalEnvironmentIn):
    pass
