...
class RequiredListResponseMessageOut(TypedDict):
    data: typing.List[MessageOut]

    done: bool

class OptionalListResponseMessageOut(TypedDict, total=False):
    iterator: typing.Optional[str]

    prevIterator: typing.Optional[str]

class ListResponseMessageOut(RequiredListResponseMessageOut, OptionalListResponseMessageOut):
    pass
