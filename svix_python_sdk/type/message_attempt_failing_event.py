...
from svix_python_sdk.type.message_attempt_failing_event_data import MessageAttemptFailingEventData

class RequiredMessageAttemptFailingEvent(TypedDict):
    data: MessageAttemptFailingEventData

    type: str

class OptionalMessageAttemptFailingEvent(TypedDict, total=False):
    pass

class MessageAttemptFailingEvent(RequiredMessageAttemptFailingEvent, OptionalMessageAttemptFailingEvent):
    pass
