...
from svix_python_sdk.type.message_attempt_failed_data import MessageAttemptFailedData

class RequiredMessageAttemptExhaustedEventData(TypedDict):
    # The app's ID
    appId: str
...
class OptionalMessageAttemptExhaustedEventData(TypedDict, total=False):
    # The app's UID
    appUid: typing.Optional[str]

    # The msg's UID
    msgEventId: typing.Optional[str]

class MessageAttemptExhaustedEventData(RequiredMessageAttemptExhaustedEventData, OptionalMessageAttemptExhaustedEventData):
    pass
