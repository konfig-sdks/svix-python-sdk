...
class RequiredEndpointHeadersPatchIn(TypedDict):
    headers: EndpointHeadersPatchInHeaders

class OptionalEndpointHeadersPatchIn(TypedDict, total=False):
    pass

class EndpointHeadersPatchIn(RequiredEndpointHeadersPatchIn, OptionalEndpointHeadersPatchIn):
    pass
