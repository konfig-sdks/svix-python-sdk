...
class RequiredMessageAttemptFailingEventData(TypedDict):
    # The app's ID
    appId: str
...
class OptionalMessageAttemptFailingEventData(TypedDict, total=False):
    # The app's UID
...
class MessageAttemptFailingEventData(RequiredMessageAttemptFailingEventData, OptionalMessageAttemptFailingEventData):
    pass
