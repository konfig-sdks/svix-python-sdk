...
class RequiredMessageBroadcastOut(TypedDict):
    id: str
...
class OptionalMessageBroadcastOut(TypedDict, total=False):
    pass

class MessageBroadcastOut(RequiredMessageBroadcastOut, OptionalMessageBroadcastOut):
    pass
