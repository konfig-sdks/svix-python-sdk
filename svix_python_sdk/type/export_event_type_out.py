...
class RequiredExportEventTypeOut(TypedDict):
    id: str
...
class OptionalExportEventTypeOut(TypedDict, total=False):
    pass

class ExportEventTypeOut(RequiredExportEventTypeOut, OptionalExportEventTypeOut):
    pass
