...
class RequiredMessageIn(TypedDict):
    # The event type's name
    eventType: str

    payload: typing.Dict[str, typing.Union[bool, date, datetime, dict, float, int, list, str, None]]

class OptionalMessageIn(TypedDict, total=False):
    tags: MessageInTags

    # Optional unique identifier for the message
    eventId: typing.Optional[str]

    channels: MessageInChannels

    payloadRetentionPeriod: int

    application: ApplicationIn

    # Extra parameters to pass to Transformations (for future use)
    transformationsParams: typing.Optional[typing.Dict[str, typing.Union[bool, date, datetime, dict, float, int, list, str, None]]]

class MessageIn(RequiredMessageIn, OptionalMessageIn):
    pass
