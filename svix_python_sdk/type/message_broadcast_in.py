...
from svix_python_sdk.type.message_broadcast_in_channels import MessageBroadcastInChannels

class RequiredMessageBroadcastIn(TypedDict):
    # The event type's name
    eventType: str

    payload: typing.Dict[str, typing.Union[bool, date, datetime, dict, float, int, list, str, None]]

class OptionalMessageBroadcastIn(TypedDict, total=False):
    # Optional unique identifier for the message
    eventId: typing.Optional[str]

    channels: MessageBroadcastInChannels

    payloadRetentionPeriod: int

class MessageBroadcastIn(RequiredMessageBroadcastIn, OptionalMessageBroadcastIn):
    pass
