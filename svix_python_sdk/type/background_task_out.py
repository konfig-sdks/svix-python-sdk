...
class RequiredBackgroundTaskOut(TypedDict):
...
class OptionalBackgroundTaskOut(TypedDict, total=False):
    pass

class BackgroundTaskOut(RequiredBackgroundTaskOut, OptionalBackgroundTaskOut):
    pass
