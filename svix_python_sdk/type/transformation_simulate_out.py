...
class RequiredTransformationSimulateOut(TypedDict):
    url: str

    payload: str

class OptionalTransformationSimulateOut(TypedDict, total=False):
    method: TransformationHttpMethod

class TransformationSimulateOut(RequiredTransformationSimulateOut, OptionalTransformationSimulateOut):
    pass
