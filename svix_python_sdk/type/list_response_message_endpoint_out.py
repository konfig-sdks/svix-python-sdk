...
from svix_python_sdk.type.message_endpoint_out import MessageEndpointOut

class RequiredListResponseMessageEndpointOut(TypedDict):
    data: typing.List[MessageEndpointOut]

    done: bool

class OptionalListResponseMessageEndpointOut(TypedDict, total=False):
    iterator: typing.Optional[str]

    prevIterator: typing.Optional[str]

class ListResponseMessageEndpointOut(RequiredListResponseMessageEndpointOut, OptionalListResponseMessageEndpointOut):
    pass
