...
from svix_python_sdk.type.message_attempt_recovered_event_data import MessageAttemptRecoveredEventData

class RequiredMessageAttemptRecoveredEvent(TypedDict):
    data: MessageAttemptRecoveredEventData

    type: str

class OptionalMessageAttemptRecoveredEvent(TypedDict, total=False):
    pass

class MessageAttemptRecoveredEvent(RequiredMessageAttemptRecoveredEvent, OptionalMessageAttemptRecoveredEvent):
    pass
