...
class RequiredListResponseMessageAttemptOut(TypedDict):
    data: typing.List[MessageAttemptOut]

    done: bool

class OptionalListResponseMessageAttemptOut(TypedDict, total=False):
    iterator: typing.Optional[str]

    prevIterator: typing.Optional[str]

class ListResponseMessageAttemptOut(RequiredListResponseMessageAttemptOut, OptionalListResponseMessageAttemptOut):
    pass
