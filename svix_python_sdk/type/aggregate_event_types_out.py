...
class RequiredAggregateEventTypesOut(TypedDict):
    id: str
...
class OptionalAggregateEventTypesOut(TypedDict, total=False):
    pass

class AggregateEventTypesOut(RequiredAggregateEventTypesOut, OptionalAggregateEventTypesOut):
    pass
