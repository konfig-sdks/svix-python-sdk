...
class RequiredInboundPathParams(TypedDict):
    # The app's ID or UID
    app_id: str

    inbound_token: str

class OptionalInboundPathParams(TypedDict, total=False):
    pass

class InboundPathParams(RequiredInboundPathParams, OptionalInboundPathParams):
    pass
