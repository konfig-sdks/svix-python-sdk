...
class RequiredEndpointDeletedEventData(TypedDict):
    # The app's ID
    appId: str
...
class OptionalEndpointDeletedEventData(TypedDict, total=False):
    # The app's UID
...
class EndpointDeletedEventData(RequiredEndpointDeletedEventData, OptionalEndpointDeletedEventData):
    pass
