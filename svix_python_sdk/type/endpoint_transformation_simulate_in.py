...
from svix_python_sdk.type.endpoint_transformation_simulate_in_channels import EndpointTransformationSimulateInChannels

class RequiredEndpointTransformationSimulateIn(TypedDict):
    code: str
...
class OptionalEndpointTransformationSimulateIn(TypedDict, total=False):
    channels: EndpointTransformationSimulateInChannels

class EndpointTransformationSimulateIn(RequiredEndpointTransformationSimulateIn, OptionalEndpointTransformationSimulateIn):
    pass
