...
class RequiredIntegrationKeyOut(TypedDict):
    key: str

class OptionalIntegrationKeyOut(TypedDict, total=False):
    pass

class IntegrationKeyOut(RequiredIntegrationKeyOut, OptionalIntegrationKeyOut):
    pass
