...
from svix_python_sdk.type.custom_color_palette import CustomColorPalette
from svix_python_sdk.type.custom_theme_override import CustomThemeOverride

class RequiredSettingsOut(TypedDict):
    pass

class OptionalSettingsOut(TypedDict, total=False):
    customColor: typing.Optional[str]

    customLogoUrl: typing.Optional[str]

    customThemeOverride: CustomThemeOverride

    customBaseFontSize: typing.Optional[int]

    customFontFamily: typing.Optional[str]

    customFontFamilyUrl: typing.Optional[str]

    disableEndpointOnFailure: bool

    displayName: typing.Optional[str]

    eventCatalogPublished: bool
    ...
    enableIntegrationManagement: bool
    ...
    showUseSvixPlay: bool

class SettingsOut(RequiredSettingsOut, OptionalSettingsOut):
    pass
