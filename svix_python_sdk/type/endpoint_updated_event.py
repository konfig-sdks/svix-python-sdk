...
from svix_python_sdk.type.endpoint_updated_event_data import EndpointUpdatedEventData

class RequiredEndpointUpdatedEvent(TypedDict):
    data: EndpointUpdatedEventData

    type: str

class OptionalEndpointUpdatedEvent(TypedDict, total=False):
    pass

class EndpointUpdatedEvent(RequiredEndpointUpdatedEvent, OptionalEndpointUpdatedEvent):
    pass
