...
class RequiredOneTimeTokenIn(TypedDict):
    oneTimeToken: str

class OptionalOneTimeTokenIn(TypedDict, total=False):
    pass

class OneTimeTokenIn(RequiredOneTimeTokenIn, OptionalOneTimeTokenIn):
    pass
