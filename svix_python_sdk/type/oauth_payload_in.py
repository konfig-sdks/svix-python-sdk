...
class RequiredOauthPayloadIn(TypedDict):
    code: str

    redirectUri: str

class OptionalOauthPayloadIn(TypedDict, total=False):
    pass

class OauthPayloadIn(RequiredOauthPayloadIn, OptionalOauthPayloadIn):
    pass
