...
class RequiredMessageAttemptRecoveredEventData(TypedDict):
    # The app's ID
    appId: str
...
class OptionalMessageAttemptRecoveredEventData(TypedDict, total=False):
    # The app's UID
...
class MessageAttemptRecoveredEventData(RequiredMessageAttemptRecoveredEventData, OptionalMessageAttemptRecoveredEventData):
    pass
