...
class RequiredMessageAttemptOut(TypedDict):
    url: str
...
class OptionalMessageAttemptOut(TypedDict, total=False):
    msg: MessageOut

class MessageAttemptOut(RequiredMessageAttemptOut, OptionalMessageAttemptOut):
    pass
