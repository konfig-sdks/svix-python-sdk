...
from svix_python_sdk.type.endpoint_message_out import EndpointMessageOut

class RequiredListResponseEndpointMessageOut(TypedDict):
    data: typing.List[EndpointMessageOut]

    done: bool

class OptionalListResponseEndpointMessageOut(TypedDict, total=False):
    iterator: typing.Optional[str]

    prevIterator: typing.Optional[str]

class ListResponseEndpointMessageOut(RequiredListResponseEndpointMessageOut, OptionalListResponseEndpointMessageOut):
    pass
