...
from svix_python_sdk.type.event_type_out_schemas import EventTypeOutSchemas

class RequiredEventTypeOut(TypedDict):
    description: str
...
class OptionalEventTypeOut(TypedDict, total=False):
    archived: bool

    schemas: EventTypeOutSchemas

    featureFlag: typing.Optional[str]

class EventTypeOut(RequiredEventTypeOut, OptionalEventTypeOut):
    pass
