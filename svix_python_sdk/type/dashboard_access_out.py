...
class RequiredDashboardAccessOut(TypedDict):
    url: str

    token: str

class OptionalDashboardAccessOut(TypedDict, total=False):
    pass

class DashboardAccessOut(RequiredDashboardAccessOut, OptionalDashboardAccessOut):
    pass
