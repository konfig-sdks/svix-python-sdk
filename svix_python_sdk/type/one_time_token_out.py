...
class RequiredOneTimeTokenOut(TypedDict):
    token: str

class OptionalOneTimeTokenOut(TypedDict, total=False):
    pass

class OneTimeTokenOut(RequiredOneTimeTokenOut, OptionalOneTimeTokenOut):
    pass
