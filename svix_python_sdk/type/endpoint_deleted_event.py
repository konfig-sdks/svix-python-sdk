...
from svix_python_sdk.type.endpoint_deleted_event_data import EndpointDeletedEventData

class RequiredEndpointDeletedEvent(TypedDict):
    data: EndpointDeletedEventData

    type: str

class OptionalEndpointDeletedEvent(TypedDict, total=False):
    pass

class EndpointDeletedEvent(RequiredEndpointDeletedEvent, OptionalEndpointDeletedEvent):
    pass
