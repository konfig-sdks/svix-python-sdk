...
from svix_python_sdk.type.message_attempt_exhausted_event_data import MessageAttemptExhaustedEventData

class RequiredMessageAttemptExhaustedEvent(TypedDict):
    data: MessageAttemptExhaustedEventData

    type: str

class OptionalMessageAttemptExhaustedEvent(TypedDict, total=False):
    pass

class MessageAttemptExhaustedEvent(RequiredMessageAttemptExhaustedEvent, OptionalMessageAttemptExhaustedEvent):
    pass
