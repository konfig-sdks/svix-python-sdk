...
from svix_python_sdk.type.completion_choice import CompletionChoice

class RequiredGenerateOut(TypedDict):
    id: str
...
class OptionalGenerateOut(TypedDict, total=False):
    pass

class GenerateOut(RequiredGenerateOut, OptionalGenerateOut):
    pass
