...
class RequiredEndpointSecretOut(TypedDict):
...
class OptionalEndpointSecretOut(TypedDict, total=False):
    pass

class EndpointSecretOut(RequiredEndpointSecretOut, OptionalEndpointSecretOut):
    pass
