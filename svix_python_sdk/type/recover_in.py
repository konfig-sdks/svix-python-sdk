...
class RequiredRecoverIn(TypedDict):
    since: datetime

class OptionalRecoverIn(TypedDict, total=False):
    until: typing.Optional[datetime]

class RecoverIn(RequiredRecoverIn, OptionalRecoverIn):
    pass
