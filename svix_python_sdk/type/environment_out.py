...
from svix_python_sdk.type.settings_out import SettingsOut

class RequiredEnvironmentOut(TypedDict):
    createdAt: datetime

    eventTypes: typing.List[EventTypeOut]

class OptionalEnvironmentOut(TypedDict, total=False):
    version: int

    settings: SettingsOut

class EnvironmentOut(RequiredEnvironmentOut, OptionalEnvironmentOut):
    pass
