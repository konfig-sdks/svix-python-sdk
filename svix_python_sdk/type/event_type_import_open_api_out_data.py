...
from svix_python_sdk.type.event_type_import_open_api_out_data_modified import EventTypeImportOpenApiOutDataModified

class RequiredEventTypeImportOpenApiOutData(TypedDict):
    modified: EventTypeImportOpenApiOutDataModified

class OptionalEventTypeImportOpenApiOutData(TypedDict, total=False):
    pass

class EventTypeImportOpenApiOutData(RequiredEventTypeImportOpenApiOutData, OptionalEventTypeImportOpenApiOutData):
    pass
