...
class RequiredAppUsageStatsIn(TypedDict):
    since: datetime

    until: datetime

class OptionalAppUsageStatsIn(TypedDict, total=False):
    appIds: AppUsageStatsInAppIds

class AppUsageStatsIn(RequiredAppUsageStatsIn, OptionalAppUsageStatsIn):
    pass
