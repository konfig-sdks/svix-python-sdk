...
class RequiredAppPortalAccessIn(TypedDict):
    pass

class OptionalAppPortalAccessIn(TypedDict, total=False):
    featureFlags: AppPortalAccessInFeatureFlags
...
class AppPortalAccessIn(RequiredAppPortalAccessIn, OptionalAppPortalAccessIn):
    pass
