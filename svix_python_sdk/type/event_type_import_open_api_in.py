...
class RequiredEventTypeImportOpenApiIn(TypedDict):
    pass

class OptionalEventTypeImportOpenApiIn(TypedDict, total=False):
    spec: EventTypeImportOpenApiInSpec

    # A string, parsed by the server as YAML or JSON.
    specRaw: typing.Optional[str]

class EventTypeImportOpenApiIn(RequiredEventTypeImportOpenApiIn, OptionalEventTypeImportOpenApiIn):
    pass
