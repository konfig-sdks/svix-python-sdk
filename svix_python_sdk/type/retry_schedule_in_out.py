...
from svix_python_sdk.type.retry_schedule import RetrySchedule

class RequiredRetryScheduleInOut(TypedDict):
    pass

class OptionalRetryScheduleInOut(TypedDict, total=False):
    retrySchedule: RetrySchedule

class RetryScheduleInOut(RequiredRetryScheduleInOut, OptionalRetryScheduleInOut):
    pass
