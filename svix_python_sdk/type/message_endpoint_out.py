...
from svix_python_sdk.type.message_endpoint_out_channels import MessageEndpointOutChannels
from svix_python_sdk.type.message_endpoint_out_filter_types import MessageEndpointOutFilterTypes
from svix_python_sdk.type.message_status import MessageStatus

class RequiredMessageEndpointOut(TypedDict):
...
class OptionalMessageEndpointOut(TypedDict, total=False):
    nextAttempt: typing.Optional[datetime]
    ...
    filterTypes: MessageEndpointOutFilterTypes

    channels: MessageEndpointOutChannels

class MessageEndpointOut(RequiredMessageEndpointOut, OptionalMessageEndpointOut):
    pass
