...
class RequiredListResponseApplicationOut(TypedDict):
    data: typing.List[ApplicationOut]

    done: bool

class OptionalListResponseApplicationOut(TypedDict, total=False):
    iterator: typing.Optional[str]

    prevIterator: typing.Optional[str]

class ListResponseApplicationOut(RequiredListResponseApplicationOut, OptionalListResponseApplicationOut):
    pass
