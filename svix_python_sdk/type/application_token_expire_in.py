...
class RequiredApplicationTokenExpireIn(TypedDict):
    pass

class OptionalApplicationTokenExpireIn(TypedDict, total=False):
    # How many seconds until the old key is expired.
    expiry: typing.Optional[int]

class ApplicationTokenExpireIn(RequiredApplicationTokenExpireIn, OptionalApplicationTokenExpireIn):
    pass
