...
class RequiredMessageAttemptFailedData(TypedDict):
    # The attempt's ID
    id: str
...
class OptionalMessageAttemptFailedData(TypedDict, total=False):
    pass

class MessageAttemptFailedData(RequiredMessageAttemptFailedData, OptionalMessageAttemptFailedData):
    pass
