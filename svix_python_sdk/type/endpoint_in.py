...
class RequiredEndpointIn(TypedDict):
    url: str

class OptionalEndpointIn(TypedDict, total=False):
    description: str
    ...
    filterTypes: EndpointInFilterTypes

    channels: EndpointInChannels
    ...
    metadata: EndpointInMetadata

class EndpointIn(RequiredEndpointIn, OptionalEndpointIn):
    pass
