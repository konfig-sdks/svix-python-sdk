...
class RequiredEndpointHeadersIn(TypedDict):
    headers: EndpointHeadersInHeaders

class OptionalEndpointHeadersIn(TypedDict, total=False):
    pass

class EndpointHeadersIn(RequiredEndpointHeadersIn, OptionalEndpointHeadersIn):
    pass
