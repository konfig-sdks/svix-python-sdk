...
from svix_python_sdk.paths.api_v1_background_task_task_id.get import GetTaskById
from svix_python_sdk.paths.api_v1_background_task.get import ListRecentTasks
from svix_python_sdk.apis.tags.background_tasks_api_raw import BackgroundTasksApiRaw
...
class BackgroundTasksApi(
    ...
    """
    raw: BackgroundTasksApiRaw

    def __init__(self, api_client=None):
        super().__init__(api_client)
        self.raw = BackgroundTasksApiRaw(api_client)
