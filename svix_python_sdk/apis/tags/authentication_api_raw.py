...
from svix_python_sdk.paths.api_v1_auth_app_app_id_expire_all.post import ExpireAllTokensRaw
from svix_python_sdk.paths.api_v1_auth_app_portal_access_app_id.post import GenerateMagicLinksRaw
from svix_python_sdk.paths.api_v1_auth_dashboard_access_app_id.post import GetMagicLinksRaw
from svix_python_sdk.paths.api_v1_auth_logout.post import LogoutTokenRaw


class AuthenticationApiRaw(
    ExpireAllTokensRaw,
    GenerateMagicLinksRaw,
    GetMagicLinksRaw,
    LogoutTokenRaw,
):
    """NOTE:
