...
from svix_python_sdk.paths.api_v1_auth_app_app_id_expire_all.post import ExpireAppTokensRaw
from svix_python_sdk.paths.api_v1_auth_dashboard_access_app_id.post import GenerateMagicLinkRaw
from svix_python_sdk.paths.api_v1_auth_app_portal_access_app_id.post import ObtainMagicLinkAndCodeRaw
from svix_python_sdk.paths.api_v1_auth_logout.post import RevokeTokenRaw


class AuthenticationApiRaw(
    ExpireAppTokensRaw,
    GenerateMagicLinkRaw,
    ObtainMagicLinkAndCodeRaw,
    RevokeTokenRaw,
):
    """NOTE:
