...
from svix_python_sdk.paths.api_v1_stats_usage_event_types.put import CalculateEventTypesForAppsRaw
from svix_python_sdk.paths.api_v1_stats_usage_app.post import CalculateMessageDestinationsForAppsRaw


class StatisticsApiRaw(
    CalculateEventTypesForAppsRaw,
    CalculateMessageDestinationsForAppsRaw,
):
    """NOTE:
