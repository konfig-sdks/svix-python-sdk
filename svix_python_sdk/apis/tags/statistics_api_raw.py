...
from svix_python_sdk.paths.api_v1_stats_usage_event_types.put import CalculateEventTypesForAllAppsRaw
from svix_python_sdk.paths.api_v1_stats_usage_app.post import CalculateMessageDestinationsRaw


class StatisticsApiRaw(
    CalculateEventTypesForAllAppsRaw,
    CalculateMessageDestinationsRaw,
):
    """NOTE:
