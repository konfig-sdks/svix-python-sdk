...
from svix_python_sdk.paths.api_v1_background_task_task_id.get import GetTaskByIdRaw
from svix_python_sdk.paths.api_v1_background_task.get import ListRecentTasksRaw


class BackgroundTasksApiRaw(
    GetTaskByIdRaw,
    ListRecentTasksRaw,
):
    """NOTE:
