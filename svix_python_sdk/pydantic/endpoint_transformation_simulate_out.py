...
from svix_python_sdk.pydantic.transformation_http_method import TransformationHttpMethod

class EndpointTransformationSimulateOut(BaseModel):
    url: str = Field(alias='url')

    payload: str = Field(alias='payload')

    method: typing.Optional[TransformationHttpMethod] = Field(None, alias='method')
    class Config:
