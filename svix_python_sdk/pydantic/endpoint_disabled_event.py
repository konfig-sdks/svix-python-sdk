...
from svix_python_sdk.pydantic.endpoint_disabled_event_data import EndpointDisabledEventData

class EndpointDisabledEvent(BaseModel):
    data: EndpointDisabledEventData = Field(alias='data')

    type: Literal["endpoint.disabled"] = Field(alias='type')
    class Config:
