...
from svix_python_sdk.pydantic.event_type_import_open_api_out_data import EventTypeImportOpenApiOutData

class EventTypeImportOpenApiOut(BaseModel):
    data: EventTypeImportOpenApiOutData = Field(alias='data')
    class Config:
