...
from svix_python_sdk.pydantic.event_type_import_open_api_in_spec import EventTypeImportOpenApiInSpec

class EventTypeImportOpenApiIn(BaseModel):
    spec: typing.Optional[EventTypeImportOpenApiInSpec] = Field(None, alias='spec')

    # A string, parsed by the server as YAML or JSON.
    spec_raw: typing.Optional[typing.Optional[str]] = Field(None, alias='specRaw')
    class Config:
