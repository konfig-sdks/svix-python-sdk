...
from svix_python_sdk.pydantic.background_task_status import BackgroundTaskStatus
from svix_python_sdk.pydantic.background_task_type import BackgroundTaskType

class ExportEventTypeOut(BaseModel):
    id: str = Field(alias='id')

    status: BackgroundTaskStatus = Field(alias='status')

    task: BackgroundTaskType = Field(alias='task')
    class Config:
