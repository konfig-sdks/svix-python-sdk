...
from svix_python_sdk.pydantic.message_attempt_trigger_type import MessageAttemptTriggerType
from svix_python_sdk.pydantic.message_out import MessageOut
...
class MessageAttemptEndpointOut(BaseModel):
    ...
    msg: typing.Optional[MessageOut] = Field(None, alias='msg')
    class Config:
