...
from svix_python_sdk.pydantic.message_attempt_headers_out_response_headers_item import MessageAttemptHeadersOutResponseHeadersItem

MessageAttemptHeadersOutResponseHeaders = typing.Optional[typing.List[MessageAttemptHeadersOutResponseHeadersItem]]
