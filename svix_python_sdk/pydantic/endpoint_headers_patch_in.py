...
from svix_python_sdk.pydantic.endpoint_headers_patch_in_headers import EndpointHeadersPatchInHeaders

class EndpointHeadersPatchIn(BaseModel):
    headers: EndpointHeadersPatchInHeaders = Field(alias='headers')
    class Config:
