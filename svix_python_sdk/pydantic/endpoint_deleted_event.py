...
from svix_python_sdk.pydantic.endpoint_deleted_event_data import EndpointDeletedEventData

class EndpointDeletedEvent(BaseModel):
    data: EndpointDeletedEventData = Field(alias='data')

    type: Literal["endpoint.deleted"] = Field(alias='type')
    class Config:
