...
from svix_python_sdk.pydantic.settings_out import SettingsOut

class EnvironmentOut(BaseModel):
    created_at: datetime = Field(alias='createdAt')

    event_types: typing.List[EventTypeOut] = Field(alias='eventTypes')

    version: typing.Optional[int] = Field(None, alias='version')

    settings: typing.Optional[SettingsOut] = Field(None, alias='settings')
    class Config:
