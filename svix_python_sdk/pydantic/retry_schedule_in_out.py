...
from svix_python_sdk.pydantic.retry_schedule import RetrySchedule

class RetryScheduleInOut(BaseModel):
    retry_schedule: typing.Optional[RetrySchedule] = Field(None, alias='retrySchedule')
    class Config:
