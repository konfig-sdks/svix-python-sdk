...
from svix_python_sdk.pydantic.application_in_metadata import ApplicationInMetadata
...
class ApplicationIn(BaseModel):
    ...
    metadata: typing.Optional[ApplicationInMetadata] = Field(None, alias='metadata')
    class Config:
