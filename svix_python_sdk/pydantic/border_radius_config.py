...
from svix_python_sdk.pydantic.border_radius_enum import BorderRadiusEnum

class BorderRadiusConfig(BaseModel):
    button: typing.Optional[BorderRadiusEnum] = Field(None, alias='button')

    card: typing.Optional[BorderRadiusEnum] = Field(None, alias='card')

    input: typing.Optional[BorderRadiusEnum] = Field(None, alias='input')
    class Config:
