...
from svix_python_sdk.pydantic.application_patch_metadata import ApplicationPatchMetadata
...
class ApplicationPatch(BaseModel):
    ...
    metadata: typing.Optional[ApplicationPatchMetadata] = Field(None, alias='metadata')
    class Config:
