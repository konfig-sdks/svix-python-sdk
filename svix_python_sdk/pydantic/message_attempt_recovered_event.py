...
from svix_python_sdk.pydantic.message_attempt_recovered_event_data import MessageAttemptRecoveredEventData

class MessageAttemptRecoveredEvent(BaseModel):
    data: MessageAttemptRecoveredEventData = Field(alias='data')

    type: Literal["message.attempt.recovered"] = Field(alias='type')
    class Config:
