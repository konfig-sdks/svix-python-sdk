...
from svix_python_sdk.pydantic.event_type_patch_schemas import EventTypePatchSchemas
...
class EventTypePatch(BaseModel):
    ...
    schemas: typing.Optional[EventTypePatchSchemas] = Field(None, alias='schemas')
