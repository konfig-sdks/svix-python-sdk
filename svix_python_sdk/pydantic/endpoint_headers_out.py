...
from svix_python_sdk.pydantic.endpoint_headers_out_headers import EndpointHeadersOutHeaders
from svix_python_sdk.pydantic.endpoint_headers_out_sensitive import EndpointHeadersOutSensitive

class EndpointHeadersOut(BaseModel):
    headers: EndpointHeadersOutHeaders = Field(alias='headers')

    sensitive: EndpointHeadersOutSensitive = Field(alias='sensitive')
    class Config:
