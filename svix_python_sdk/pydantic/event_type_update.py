...
from svix_python_sdk.pydantic.event_type_update_schemas import EventTypeUpdateSchemas
...
class EventTypeUpdate(BaseModel):
    ...
    schemas: typing.Optional[EventTypeUpdateSchemas] = Field(None, alias='schemas')
