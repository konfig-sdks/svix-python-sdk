...
from svix_python_sdk.pydantic.event_type_import_open_api_out_data_modified import EventTypeImportOpenApiOutDataModified

class EventTypeImportOpenApiOutData(BaseModel):
    modified: EventTypeImportOpenApiOutDataModified = Field(alias='modified')
    class Config:
