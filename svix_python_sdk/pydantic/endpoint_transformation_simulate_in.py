...
from svix_python_sdk.pydantic.endpoint_transformation_simulate_in_channels import EndpointTransformationSimulateInChannels

class EndpointTransformationSimulateIn(BaseModel):
    ...
    channels: typing.Optional[EndpointTransformationSimulateInChannels] = Field(None, alias='channels')
    class Config:
