...
from svix_python_sdk.pydantic.border_radius_config import BorderRadiusConfig
from svix_python_sdk.pydantic.font_size_config import FontSizeConfig

class CustomThemeOverride(BaseModel):
    border_radius: typing.Optional[BorderRadiusConfig] = Field(None, alias='borderRadius')

    font_size: typing.Optional[FontSizeConfig] = Field(None, alias='fontSize')
    class Config:
