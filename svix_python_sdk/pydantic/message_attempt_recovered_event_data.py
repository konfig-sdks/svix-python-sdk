...
from svix_python_sdk.pydantic.message_attempt_failed_data import MessageAttemptFailedData

class MessageAttemptRecoveredEventData(BaseModel):
    # The app's ID
    ...
    # The app's UID
    app_uid: typing.Optional[typing.Optional[str]] = Field(None, alias='appUid')

    # The msg's UID
    msg_event_id: typing.Optional[typing.Optional[str]] = Field(None, alias='msgEventId')
    class Config:
