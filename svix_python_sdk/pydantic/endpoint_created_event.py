...
from svix_python_sdk.pydantic.endpoint_created_event_data import EndpointCreatedEventData

class EndpointCreatedEvent(BaseModel):
    data: EndpointCreatedEventData = Field(alias='data')

    type: Literal["endpoint.created"] = Field(alias='type')
    class Config:
