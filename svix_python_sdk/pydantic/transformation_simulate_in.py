...
from svix_python_sdk.pydantic.transformation_simulate_in_channels import TransformationSimulateInChannels

class TransformationSimulateIn(BaseModel):
    ...
    channels: typing.Optional[TransformationSimulateInChannels] = Field(None, alias='channels')
    class Config:
