...
from svix_python_sdk.pydantic.endpoint_updated_event_data import EndpointUpdatedEventData

class EndpointUpdatedEvent(BaseModel):
    data: EndpointUpdatedEventData = Field(alias='data')

    type: Literal["endpoint.updated"] = Field(alias='type')
    class Config:
