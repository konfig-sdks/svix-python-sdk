...
from svix_python_sdk.pydantic.message_attempt_failing_event_data import MessageAttemptFailingEventData

class MessageAttemptFailingEvent(BaseModel):
    data: MessageAttemptFailingEventData = Field(alias='data')

    type: Literal["message.attempt.failing"] = Field(alias='type')
    class Config:
