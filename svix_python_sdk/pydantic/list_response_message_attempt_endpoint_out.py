...
from svix_python_sdk.pydantic.message_attempt_endpoint_out import MessageAttemptEndpointOut

class ListResponseMessageAttemptEndpointOut(BaseModel):
    data: typing.List[MessageAttemptEndpointOut] = Field(alias='data')

    done: bool = Field(alias='done')

    iterator: typing.Optional[typing.Optional[str]] = Field(None, alias='iterator')

    prev_iterator: typing.Optional[typing.Optional[str]] = Field(None, alias='prevIterator')
    class Config:
