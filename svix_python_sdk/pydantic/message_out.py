...
from svix_python_sdk.pydantic.message_out_channels import MessageOutChannels
from svix_python_sdk.pydantic.message_out_tags import MessageOutTags
...
class MessageOut(BaseModel):
    ...
    tags: typing.Optional[MessageOutTags] = Field(None, alias='tags')

    # Optional unique identifier for the message
    event_id: typing.Optional[typing.Optional[str]] = Field(None, alias='eventId')

    channels: typing.Optional[MessageOutChannels] = Field(None, alias='channels')
    class Config:
