...
from svix_python_sdk.pydantic.app_usage_stats_in_app_ids import AppUsageStatsInAppIds
...
class AppUsageStatsIn(BaseModel):
    ...
    app_ids: typing.Optional[AppUsageStatsInAppIds] = Field(None, alias='appIds')
    class Config:
