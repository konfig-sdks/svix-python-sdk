...
from svix_python_sdk.pydantic.app_portal_access_in_feature_flags import AppPortalAccessInFeatureFlags

class AppPortalAccessIn(BaseModel):
    feature_flags: typing.Optional[AppPortalAccessInFeatureFlags] = Field(None, alias='featureFlags')

    # How long the token will be valid for, in seconds. Valid values are between 1 hour and 7 days. The default is 7 days.
    expiry: typing.Optional[typing.Optional[int]] = Field(None, alias='expiry')
    class Config:
