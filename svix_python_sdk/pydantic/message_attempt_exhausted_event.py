...
from svix_python_sdk.pydantic.message_attempt_exhausted_event_data import MessageAttemptExhaustedEventData

class MessageAttemptExhaustedEvent(BaseModel):
    data: MessageAttemptExhaustedEventData = Field(alias='data')

    type: Literal["message.attempt.exhausted"] = Field(alias='type')
    class Config:
