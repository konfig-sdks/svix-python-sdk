...
from svix_python_sdk.pydantic.message_broadcast_in_channels import MessageBroadcastInChannels
...
class MessageBroadcastIn(BaseModel):
    ...
    channels: typing.Optional[MessageBroadcastInChannels] = Field(None, alias='channels')
