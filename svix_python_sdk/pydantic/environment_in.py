...
from svix_python_sdk.pydantic.event_type_in import EventTypeIn
from svix_python_sdk.pydantic.settings_in import SettingsIn
...
class EnvironmentIn(BaseModel):
    ...
    event_types: typing.Optional[typing.Optional[typing.List[EventTypeIn]]] = Field(None, alias='eventTypes')

    settings: typing.Optional[SettingsIn] = Field(None, alias='settings')
    class Config:
