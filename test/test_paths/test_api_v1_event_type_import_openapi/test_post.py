...
from svix_python_sdk.paths.api_v1_event_type_import_openapi import post
from svix_python_sdk import configuration, schemas, api_client

from .. import ApiTestMixin


class TestApiV1EventTypeImportOpenapi(ApiTestMixin, unittest.TestCase):
    """
    ApiV1EventTypeImportOpenapi unit test stubs
