...
from svix_python_sdk.paths.api_v1_auth_app_portal_access_app_id import post
from svix_python_sdk import configuration, schemas, api_client

from .. import ApiTestMixin


class TestApiV1AuthAppPortalAccessAppId(ApiTestMixin, unittest.TestCase):
    """
    ApiV1AuthAppPortalAccessAppId unit test stubs
