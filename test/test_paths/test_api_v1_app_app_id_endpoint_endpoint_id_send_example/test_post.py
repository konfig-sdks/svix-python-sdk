...
from svix_python_sdk.paths.api_v1_app_app_id_endpoint_endpoint_id_send_example import post
from svix_python_sdk import configuration, schemas, api_client

from .. import ApiTestMixin


class TestApiV1AppAppIdEndpointEndpointIdSendExample(ApiTestMixin, unittest.TestCase):
    """
    ApiV1AppAppIdEndpointEndpointIdSendExample unit test stubs
